...
class nusoap_base {
    ...
    */
    ...
    function varDump($data) {
        ob_start();
        switch(gettype($data)){
            case "boolean": echo 'bool('.($data?'true':'false').') '; break;
            case "integer": echo 'int('.$data.') '; break;
            case "double" : echo 'float('.$data.') '; break;
            case "string": echo 'string('.strlen($data).') "'.$data.'" '; break;
            case "array": print_r($data); break;
            case "object": print_r($data); break;
            case "resource": print_r($data); break;
