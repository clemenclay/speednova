...
<link media="all" type="text/css" rel="stylesheet" href="{$orderpage_dir}cart_flipcover/css/orderpage2.css" />
    ...
    <div class="row">
        ...
        <div class="span4" id="cartSummary">
            {include file='cart_flipcover/cart_summary.tpl'}
        </div>
        </div>


    {include file='cart_flipcover/pagination.tpl'}
