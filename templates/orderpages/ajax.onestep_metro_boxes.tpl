                            ...
                            {if $allowown}
                                <div class="tab-pane {if !$allowregister && !$allowtransfer} active {/if}" {if $contents[2]}style="display: none"{/if}  id="own">
                                    <div id="illupdate" class="t3 slidme align-center form-horizontal">
                                        ...
                                        .
                                        <input type="text" value="" size="7" name="tld_update" id="tld_update" class="styled span2 domain-tld"/>  <input type="submit" value="{$lang.check}" class="btn domain-check  btn-plan-1" onclick="domainCheck();
                                            return false;"/>
                                    </div>
                                </div>
                            {/if}
