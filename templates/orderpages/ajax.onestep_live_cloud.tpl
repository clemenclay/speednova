<div class="span8">
    <form id="cartforms" action="" method="post">
        ...
        <div class="billing-cycle billing-hidden" style="display: none">

            {if $product.paytype=='Once'}
                <select name="cycle"><option value="once">{$lang.once}</option></select>
                {elseif $product.paytype=='Free'}
                <select name="cycle"><option value="free">{$lang.free}</option></select>
                {else}
