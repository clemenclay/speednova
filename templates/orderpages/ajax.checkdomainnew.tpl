                ...
                {else  $ccme.status == ""}
                    ...
                    <tr class="status-row {if $smarty.foreach.foo.index%2 == 1}status-row-white{/if}">
                        ...
                        <td align="center">
                            ...
                            {/if}</td>
                        <td align="right">
                            <div class="select-status" style="line-height: 35px;"><div><a href="http://www.{$ccme.sld}{$ccme.tld}" target="_blank">WWW</a>&nbsp;<a href="{$ca_url}checkdomain&action=whois&amp;sld={$ccme.sld}&amp;tld={$ccme.tld}" onclick="window.open(this.href, '{$ccme.sld}{$ccme.tld}', 'width=500, height=500, scrollbars=1');
