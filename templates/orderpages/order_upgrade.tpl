                        ...
                        <tr >
                            <td valign="top" class="blighter fs11" style="padding-left:15px">
                                <b>{$cstom.config_cat_name}</b> 
                                    ...
                                    {/if} 
                                {elseif $cstom.new_config_name}
                                    :{$cstom.old_config_name} =&gt; {$cstom.new_config_name}
                                {elseif $cstom.old_config_name}
                                    :{$cstom.old_config_name}
                                {/if}
...
<form action="" method="post" onsubmit='$("#checkout").addLoader();'>
    ...
    <div class="orderbox"  id="checkout">
        <div class="orderboxpadding">
            <center>
                <input type="submit" value="{$lang.submit}" style="font-size:12px;font-weight:bold"  class="padded btn btn-primary"/> 
                {$lang.or} 
                <a href="?cmd=clientarea&action=services&service={$contents.product.account_id}" class="btn">{$lang.cancel}</a>
            </center>
        </div>
    </div>
</form>