...
<div class="row orderpage-config">
    ...
    <input type="hidden" name="addon[0]" value="0" />
        <div>
            <h2 class="no-ml">{$lang.productconfig}</h2>
            <h3 class="no-ml">{$lang.config_then_checkout}!</h3>

            <div class="row">


                <div class="{if $addons}span4 {else} span8 {/if}">
                    ...
                    {if $addons}
                        <div class="{if ($product.paytype!='Free' && $product.paytype!='Once') || $product.hostname}span4 {else} span8 {/if}">
                ...
                <div class="row">
                    ...
                    <div class="{if $subproducts}span4{else}span8{/if}">
                        <div class="configuration-box">
                    ...
                    {/if}
                        ...
                        {if $subproducts}
                        <div class="{if $custom}span4{else}span8{/if}">
    ...
    <div class="span4" id="orderSummary">
        <div>
            ...
            <h3 class="no-ml">{$opconfig.ordersummary}</h3>
            ...
            <div class="order-summary">
                <div class="summary-bg">
                    <table class="table">
                        ...
                        {if $product}
                            <tr>
                                <td class="desc-col">{$contents[0].category_name} - <strong>{$contents[0].name} {if $contents[0].domain}({$contents[0].domain}){/if}</strong></td>
                                <td class="price-col">
