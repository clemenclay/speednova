<script type="text/javascript">
    ...
    css.attr({
      rel:  "stylesheet",
      type: "text/css",
      href: "{/literal}{$orderpage_dir}{literal}fourbox/style.css"
    });
...
var ff=function(){
 $("#content").after($("#footer"));
     ...
     $('.pconfig2_').click(function(){
        ...
        $('.pinput_').bind("blur, keyup",function(){
...
<div id="middle">
			<a href="{$ca_url}cart/&cat_id={$current_cat}"><img src="{$orderpage_dir}fourbox/images/web_logo.png" alt=""/></a>
		</div>
