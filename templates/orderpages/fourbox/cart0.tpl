	{include file='fourbox/cart_header.tpl'}
...
<div id="tableH">
			...
			<ul id="menuT">
				...
				<li class="i2">{$lang.ram}</li>
				<li class="i3">{$lang.storagespace}</li>
				<li class="i4">{$lang.bandwidth}</li>
	...
	{include file='fourbox/cart_footer.tpl'}