...
<link media="all" type="text/css" rel="stylesheet" href="{$orderpage_dir}cart_rotatebox/css/orderpage2.css" />
...
<div class="span4" id="cartSummary">
    {include file='cart_rotatebox/cart_summary.tpl'}
</div>
</div>


{include file='cart_rotatebox/pagination.tpl'}
