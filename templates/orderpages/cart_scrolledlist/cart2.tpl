...
<link media="all" type="text/css" rel="stylesheet" href="{$orderpage_dir}cart_scrolledlist/css/orderpage2.css" />
<div class="orderpage" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="row">
        ...
        <div class="span4" id="cartSummary">
            {include file='cart_scrolledlist/cart_summary.tpl'}
        </div>
    </div>


    {include file='cart_scrolledlist/pagination.tpl'}
