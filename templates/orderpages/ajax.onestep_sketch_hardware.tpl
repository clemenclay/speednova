                ...
                {if ($product.hostname) && !($cart_contents[0].domainoptions.register=='1' ||  $allowown || $subdomain)}
                    <div class="configuration-box mt-40">
                        <div class="configuration-header">
                            <h4> {$lang.productconfig}</h4>
                        </div>
                        <div class="configuration-body">
                            <div  class="option-val">
                                <p>{$lang.hostname}</p>
                                <input name="domain" value="{$item.domain}" class="styled" size="50" 
                                       onchange="if (typeof simulateCart == 'function')
                                                   simulateCart();"/>
                            </div>
                            <div class="option-val">
                                <p>{$lang.pickcycle}</p>
    ...
    <div class="span5">
        ...
        {if $gateways}
            <div class="configuration-box">
                ...
                <div class="configuration-body no-shadow">
