...
@@thumb:: speednova_orderpage/thumb.png
@@img:: speednova_orderpage/preview.png
*}
<link media="all" type="text/css" rel="stylesheet" href="{$orderpage_dir}speednova_orderpage/css/flat-ui.css" />
<link media="all" type="text/css" rel="stylesheet" href="{$orderpage_dir}speednova_orderpage/css/orderpage.css" />
<script type="text/javascript" src="{$orderpage_dir}speednova_orderpage/js/bootstrap-select.js"></script>
<script type="text/javascript" src="{$orderpage_dir}speednova_orderpage/js/flatui-checkbox.js"></script>
<script type="text/javascript" src="{$orderpage_dir}speednova_orderpage/js/script.js"></script>
...
<div id="orderpage">
    <div class="orderpage">
        ...
        <div class="orderpage-forms clearfix" id="configer">
            <div class="clearfix">
                {include file='ajax.speednova_orderpage.tpl'}
            </div>
        </div>
