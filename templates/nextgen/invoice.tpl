        ...
        <head>
            ...
            {literal}
                ...
                <style type="text/css" media="print">
                    ...
                    #invoice-status {
                        background-image:url({/literal}{$template_dir}img/invoice_{$invoice.status}_{$language}{literal}.gif);
                    }
                    #gateway {
                        display:none;
                    }
        ...
        <body>
            {if $credit_available && $invoice.status=='Unpaid'}
                <div id="credit-applicable">
                    <div class="content">
                        <span id="inv-credit-info">{$lang.youhavecredit} <a href="#" onclick="$('#inv-credit-info').hide();
                                $('#inv-credit-form').show();
                                return false"><b>{$lang.youhavecredit2}</b></a></span>
            ...
            {/if}
            <div id="backlink"><a href="{$ca_url}clientarea/">- {$lang.backtoclientarea} -</a> {if $cancancelinvoice}
                    <a  style="color:red" href="{$ca_url}clientarea&action=invoice&id={$invoice.id}&make=cancel&security_token={$security_token}" onclick="return confirm('{$lang.manualrenew_confirm}')"><i class="icon-remove-sign"></i> {$lang.cancelinvoice}</a>
                {/if}</div>
                ...
                {if $error}
                    ...
                    <div id="invoice-content">
                        ...
                        <div id="invoice-icons">
                            ...
                            <a href="{$ca_url}root&amp;action=download&amp;invoice={$invoice.id}" onclick=""><img src="{$template_dir}img/invoice_pdf.gif" /></a>
                        ...
                        {/literal}
                        <iframe style="width: 100%" frameborder="0" scrolling="no" srcdoc="{$invoicebody|escape}" onload="resizeIframe(this)"></iframe>
                    </div>
