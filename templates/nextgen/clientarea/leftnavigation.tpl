...
{if $enableACH}
    <div class="box-feature{if $action=='ach'} active{/if}"><a href="{$ca_url}clientarea/ach/"><span class="iconfont-card iconfont-size4 silver" style=""></span></a>
        <h4>{$lang.ACHecheck}</h4>
    </div>
{/if}
