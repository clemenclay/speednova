...
*}<div class="p19"><form action='' method='post' >
        ...
        <table width="100%" border=0 cellspacing="0">
            <tbody>
                ...
                <tr><td ><input name="oldpassword" type="password" autocomplete="off"  class="styled" style="width: 60%" /></td></tr>
                <tr ><td  >{$lang.newpassword}</td></tr>
                <tr><td ><input name="password" type="password" autocomplete="off"  class="styled" style="width: 60%" /></td></tr>
                <tr><td >{$lang.confirmpassword}</td></tr>
                <tr><td ><input name="password2" type="password" autocomplete="off"  class="styled" style="width: 60%" /></td></tr>
