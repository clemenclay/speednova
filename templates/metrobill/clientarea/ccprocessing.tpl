    ...
    <article>
        ...
        <form action='' method='post' onsubmit="ccsubmit(this)" class="form-inline">
            ...
            <div class="table-box m15 overflow-h">
                ...
                <table class="table table-header-fix table-striped p-td" id="ccpcontent">
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center"><input type="submit" value="{$lang.continue}" name="continue"  class="btn btn-flat-info" style="font-weight:bold"/></td>
                        </tr>
                    </table>
            </div>
