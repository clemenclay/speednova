...
<a class="btn btn-small btn-flat-default right" href="{$ca_url}tickets/"><i class="icon-chevron-left"></i> {$lang.back}</a>
<div class="clear"></div>
</div>
    ...
    <form  enctype="multipart/form-data" method="post" action="" class="p19" id="ticketsform">
        ...
        <table width="100%" cellspacing="0" cellspacing="0"  border="0" >
            ...
            {/if}
                            ...
                            <div class="right"><input type="submit" value="{$lang.submit}"  class="btn btn-flat-success btn-large" style="font-weight: bold" id="submitbutton"/></div>
                        <div class="clear"></div>
                    </div>
                </td>
            </tr>
