        ...
        <div class="p19">
            ...
            <div class="com-con">
                <div class="{if $reply.type=='Client'}cticket{else}aticket{/if}">
                    ...
                    <a class="right btn btn-flat-default btn-small quoter" rel="tooltip" title="Quote" onclick="return quoteTicket('r{$reply.id}');"><i class="icon-share"></i></a>
            ...
            <div class="com-con">
                <div class="{if $ticket.type=='Client'}cticket{else}aticket{/if}">
                    ...
                    <a class="right btn btn-flat-default btn-small quoter" rel="tooltip" title="Quote" onclick="return quoteTicket('t{$ticket.id}');"><i class="icon-share"></i></a>
                    <div class="clear"></div>
