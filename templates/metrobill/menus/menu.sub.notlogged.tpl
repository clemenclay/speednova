...
{elseif $cmd=='cart' || $cmd=='checkdomain'}
    ...
    <li {if $cmd=='cart'}class='active'{/if}><a href="{$ca_url}cart/"><div class="vert-center">
    ...
    <li {if $cmd=='checkdomain' && $domain_cat==$cat.id}class='active'{/if}><a href="{$ca_url}checkdomain/{$cat.slug}/"><div class="vert-center">
