                    ...
                    {else}
                        ...
                        <table class="table table-striped table-aff-center p-top">
                            <tr>
                                ...
                                <td><span class="label flat-ui-label {$details.status}-label">{$lang[$details.status]}</span> <a href="http://{$details.name}" target="_blank" class="roll-link bold"><span data-title="{$details.name}">{$details.name}</span></a></td>
                            </tr>
                            <tr>
