                ...
                {foreach from=$contents item=order key=k}
                    <tbody>
                        ...
                        {if $order.total.discount}  
                            <tr >
                                <td valign="top">{$lang.discount}</td>
                                <td></td>
                                <td><strong>- {$order.total.discount|price:$currency}</strong></td>
                            </tr>  
                        {/if}
                        <tr>
                            <td colspan="3">
...
{if $suggestions}
    <div class="wbox">
        ...
        <div class="wbox_content suggested">
            <div id="slides">
                <div class="suggested-products square-list horizontal-list clearfix">
                {foreach from=$suggestions item=item}
                    <div class="pull-left">
                        <a href="{$ca_url}cart/{$item.slug}/&action=add&id={$item.id}" >
                            ...
                            <p>{$item.name}</p>
                            <div class="left-btns">
                            <a class="btn btn-flat-manage btn-small" href="{$ca_url}cart/{$item.slug}/&action=add&id={$item.id}"> {$lang.addtoorder}</a>
                            </div>
                            </div>
                        </a>
                    </div>
    ...
    <script type="text/javascript" src="{$template_dir}js/suggest.js"></script>
{/if}
    ...
    <div class="wbox">
        ...
        <div class="wbox_content">
            ...
            <table border="0" cellpadding="0" cellspacing="6" width="100%">
                ...
                {if $tos}
                    <tr>
                        <td><input type="checkbox" value="1" name="tos"/> {$lang.tos1} <a href="{$tos}" target="_blank">{$lang.tos2}</a></td>
                    </tr>
                {/if}
            </table>
        </div>
