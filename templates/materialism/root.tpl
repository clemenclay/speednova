  ...
  <div class="row no-gutter">
    ...
    <div class="col-sm-12 col-md-12 col-lg-9" style="background:#F9F9F9;">
      ...
      <div class="p-20 clearfix">
        <div class="pull-right">
          <a href="/pages/material-bird.html" target="_blank" class="btn btn-round-sm btn-link" bs-tooltip title="Play material bird"><i class="md md-games"></i></a>
          <div class="btn btn-round-sm btn-link" bs-tooltip title="Upload media"><i class="md md-crop-original"></i></div>
          <div class="btn btn-round-sm btn-link" bs-tooltip title="Write new document"><i class="md md-insert-drive-file"></i></div>
          <div class="btn btn-round-sm btn-link" bs-tooltip title="Add new user"><i class="md md-person-add"></i></div>
        </div>
        <h4 class="grey-text">
      ...
      <div class="p-20 no-p-t">
            ...
            <div class="card small">
              <div class="theme-lighten-1 p-10">
                ...
                <div class="p-10 p-t-30">
                  <c3chart bindto-id="chart-line-1">
                    <chart-column column-id="Sales"
                                  column-values="{literal}{{chartData1}}{/literal}"
                                  column-type="line"
                    ...
                    <chart-size chart-height="100px"  />
                    <chart-tooltip show-tooltip="true"  />

                    <chart-colors color-pattern="#fff"/>
                  </c3chart>
                </div>
              </div>
          ...
          <div class="col-md-4">
            <div class="card small">
              <div class="theme-secondary-lighten-1 p-10">
                ...
                <div class="p-10 p-t-30">
                  <c3chart bindto-id="chart-line-2">
                    <chart-column column-id="Customers"
                                  column-values="{literal}{{chartData2}}{/literal}"
                                  column-type="line"
          ...
          <div class="col-md-4">
            <div class="card small">
              <div class="green lighten-1 p-10">
                ...
                <div class="p-10 p-t-30">
                  <c3chart bindto-id="chart-line-3">
                    <chart-column column-id="Signups"
                                  column-values="{literal}{{chartData3}}{/literal}"
                                  column-type="line"
            ...
            <div class="card">
              <div class="card-header relative">
                ...
                <div class="floating-actions">
                  <button type="button" class="btn btn-round btn-info" bs-tooltip title="View all orders"><span class="md md-chevron-right"></span></button>
                </div>
              </div>

              <div class="list-group" ng-init="(orders=[]).length=3;">
                <a href class="list-group-item clearfix" ng-repeat="i in orders track by $index">
                  <div class="pull-left m-r-10">
                    <img placeholder-img class="img-responsive" />
                  </div>
                  <div class="list-group-item-heading" placeholder-title></div>
          ...
          <div class="col-md-4">
            ...
            <div class="panel panel-default left">
              <div class="panel-heading">
                ...
                <div class="pull-right">
                  <a href="" class="btn btn-round-sm btn-link"
                ...
                <h1 class="m-t-10 m-b-5 f30" ng-bind="serverLoad">82%</h1>
                <div class="row">
                  <div class="col-xs-6">
                    <div class="progress m-b-5">
                      <div class="progress-bar" style="width: {literal}{{serverLoad}}{/literal}%;"></div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-3">
            ...
            <div class="card">
              <div class="card-image">
                <img src="assets/img/photos/4.jpg" class="img-responsive" style="max-height:193px;" />
        ...
        <div class="row gutter-14">
          <div class="col-md-4">
            ...
            <div class="card">
              <div class="card-header relative">
                ...
                <div class="floating-actions">
                  <button type="button" class="btn btn-round btn-info" bs-tooltip title="Moderate comments"><span class="md md-chevron-right"></span></button>
                </div>
              </div>

              <div class="list-group" ng-init="(comments=[]).length=2;">
                <a href class="list-group-item clearfix" ng-repeat="i in comments track by $index">
                  <div class="pull-left m-r-10">
                    <i class="icon-circle {literal}{{theme_colors[$index]}}{/literal}-border v-super"></i>
                  </div>
                  <div class="list-group-item-heading" placeholder-name></div>
                  <p class="list-group-item-text" placeholder-p></p>
                </a>
              </div>
          ...
          <div class="col-md-8">
            ...
            <div class="card">
              ...
              <div class="m-t-20">
                <c3chart bindto-id="chart-area-1" padding-bottom="-8px"  padding-left="-20px" padding-right="-20px">
                  <chart-column
                    column-id="Customers"
                    column-values="{literal}{{chartData4}}{/literal}"
                    column-type="area"
                    />
                  <chart-axis-y show="false"  />
                  <chart-axis-x show="false"  />
                  ...
                  <chart-size chart-height="100px"  />
                  <chart-tooltip show-tooltip="true"  />
                  <chart-colors color-pattern="#EC407A"/>
                </c3chart>
              </div>
            </div>
            ...
            <div class="card bg-facebook white-text">
              <div class="card-content">
                <div class="" style="min-height: 140px;">
                  ...
                  <h5 class="f11 no-margin blue-text lighten-4 p-b-25">10 April, 2016 · <i class="fa fa-globe"></i></h5>
                </div>
                <div class="pull-right p-5">
                  <i class="fa fa-thumbs-o-up"></i> 3123 &nbsp;&nbsp;
                  <i class="fa fa-comment-o"></i> 241
                </div>
                <i class="fa fa-facebook f18"></i>
              </div>
            </div>
          </div>
            ...
            <div class="card bg-twitter white-text">
              <div class="card-content">
                <div class="" style="min-height: 140px;">
                  ...
                  <h5 class="f11 no-margin blue-text lighten-4">10 April, 2016 @wisdom</h5>
                </div>
                <div class="pull-right p-5">
                  <i class="fa fa-star-o"></i> 3123 &nbsp;&nbsp;
                  <i class="fa fa-retweet"></i> 241
                </div>
                <i class="fa fa-twitter f18"></i>
              </div>
            </div>
          </div>
        ...
        <div class="grey-text small p-t-20" ng-cloak>Materialism by Theme-Guys - v{literal}{{APP.version}}{/literal}</div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-12">
      ...
      <div class="p-h-40">
        ...
        <div role="tabpanel">
          ...
          <div class="tab-content m-t-10">
            <div role="tabpanel" class="tab-pane" ng-class="{literal}{active: actionTab==1}{/literal}">
            ...
            <div role="tabpanel" class="tab-pane" ng-class="{literal}{active: actionTab==2}{/literal}">

              <ul class="timeline" ng-init="(rows=[]).length=5;">
                <li ng-repeat="i in rows track by $index">
                  <div class="timeline-badge"><img placeholder-img class="img-responsive" /></div>
                  <div class="timeline-panel">
                    <div class="timeline-heading">
                      <h4 class="timeline-title" placeholder-name></h4>
                    </div>
                    <div class="timeline-body">
                      <p placeholder-p></p>
                      <small class="text-muted"><i class="md md-timer"></i> 11 hours ago</small>
            ...
            <div role="tabpanel" class="tab-pane" ng-class="{literal}{active: actionTab==3}{/literal}">

              <ul class="timeline" ng-init="(rows=[]).length=5;">
                <li ng-repeat="i in rows track by $index">
                  <div class="timeline-badge" placeholder-icon></div>
                  <div class="timeline-panel">
                    <div class="timeline-heading">
                      <h4 class="timeline-title" placeholder-name></h4>
                    </div>
      ...
      <div class="p-20">
        <div class="row">
          <div class="col-xs-4">
            <c3chart bindto-id="chart-gauge-1">
              <chart-column
                column-id="Gauge"
                column-type="gauge"
                column-values="80"
              ...
              <chart-size chart-height="60px"  />
              <chart-colors color-pattern="{literal}{{color_pattern}}{/literal}"/>
            </c3chart>
            <div class="text-center small">New visitors</div>
          </div>
          <div class="col-xs-4">
            <c3chart bindto-id="chart-gauge-2">
              <chart-column
                column-id="Gauge"
                column-type="gauge"
                column-values="30"
          ...
          <div class="col-xs-4">
            <c3chart bindto-id="chart-gauge-3">
              <chart-column
                column-id="Gauge"
                column-type="gauge"
                column-values="40"
      ...
      <c3chart bindto-id="chart-pagesviews" padding-bottom="-8px">
        <chart-column column-id="Pageviews"
                      column-values="3,4,5,10,20,14,18,12,10,20,10,14,15,10,20,14,18,12,10,20"
                      column-type="area"
