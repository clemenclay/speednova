                ...
                <div class="service-box  service-first service_{$secont}{counter name=secont}">
                    ...
                    <div class="service-box-bottom">
                        <div class="service-border">
                            <a class="btn c-white-btn" href="{$ca_url}clientarea/domains/"><i class="icon-c-cog"></i> {$lang.manage}<span></span></a>
                        </div>
                    </div>
                </div><!--
            {else}<!-- -->
                    ...
                    <table class="table styled-table">
                        ...
                        {foreach from=$dueinvoices item=invoice name=foo}
                            <tr class="styled-row">
                                ...
                                <td class="bold invoice-c">{$lang.invoice} #{$invoice|@invoice}</td>
