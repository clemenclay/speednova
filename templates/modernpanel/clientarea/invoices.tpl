            ...
            {if $acc_balance && $acc_balance>0 && $enableFeatures.bulkpayments!='off'}
                <li class="custom-tab">
                    <a href="#" onclick="$(this).next().submit();
                        ...
                        <i class="icon-pay-due"></i> <b class="payall-all">{$lang.paynowdueinvoices}</b>
                        <b class="payall-selected">Pay selected invoices</b> <div class="tab-right"></div>
                    </a>
                    <form method="post" action="index.php" class="no-margin form-inline" id="payall">
