                            ...
                            <tr>
                                <td >
                                    <div class="form-actions">
                                        <div class="right">
                                            <input type="submit" value="{$lang.sendmepass}" class="btn c-orange-btn" />
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </td>
            ...
            <div  class="wbox_content">
                ...
                <form name="" action="" method="post">
                    <table border="0" cellpadding="0" cellspacing="6" width="100%">
                        <tr>
                            <td align="left" colspan="2"><label for="username" class="styled">{$lang.email}</label><input name="username" type="text" value="{$submit.username}" class="styled" style="width:96%"/></td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2"><label for="password"  class="styled">{$lang.password}</label><input name="password" type="password" autocomplete="off" class="styled"  style="width:96%"/>
                            </td>
                        </tr>
                            ...
                            <td colspan="2">
                                <div class="form-actions log-in-form">
                                    ...
                                    <div class="right">
                                        ...
                                        <button type="submit" value="{$lang.login}" class="btn c-orange-btn" >
