    ...
    <div class="wbox">
        ...
        <div class="wbox_content suggested" id="slides">
            ...
            {foreach from=$suggestions item=item}
                <div class="dashboardblock pull-left span2">
                    <div class="internal">
                        <h4><a href="{$ca_url}cart/{$item.slug}/&action=add&id={$item.id}" >{$item.name}</a></h4>
                        <div class="dropup">
                            <a href="{$ca_url}cart/{$item.slug}/&action=add&id={$item.id}" class="btn btn-mini c-green-btn"><i class="icon-plus icon-white"></i> {$lang.addtoorder}</a>
                        </div>
                    </div>
                </div>
            {/foreach}
