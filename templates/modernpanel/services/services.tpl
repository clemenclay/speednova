                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="affiliates-box">
                                ...
                                <table class="table styled-table fixed-table">
                                    <tr>
                                        <th class="w0"></th>
                                        <th class="w40"><a href="{$ca_url}clientarea&amp;action={$action}&amp;cid={$cid}&amp;orderby=name|ASC" class="sortorder"><i class="icon-sort"></i>{$lang.service}</a></th>
                                        <th><a href="{$ca_url}clientarea&amp;action={$action}&amp;cid={$cid}&amp;orderby=status|ASC" class="sortorder"><i class="icon-sort"></i>{$lang.status}</a></th>
                                                {if $action=='vps'}
                                            <th>
                                                <a href="{$ca_url}clientarea&amp;action={$action}&amp;cid={$cid}&amp;orderby=domain|ASC" class="sortorder"><i class="icon-sort"></i>{$lang.hostname}</a>
                                            </th>
                                            <th>{$lang.ipadd}</th>
                                            {else}
                                            <th>
                                                <a href="{$ca_url}clientarea&amp;action={$action}&amp;cid={$cid}&amp;orderby=total|ASC" class="sortorder"><i class="icon-sort"></i>{$lang.price}</a>
                                            </th>
                                            <th>
                                                <a href="{$ca_url}clientarea&amp;action={$action}&amp;cid={$cid}&amp;orderby=billingcycle|ASC" class="sortorder"><i class="icon-sort"></i>{$lang.bcycle}</a>
                                            </th>
                                        {/if}
                                        <th colspan="2">
                                            <a href="{$ca_url}clientarea&amp;action={$action}&amp;cid={$cid}&amp;orderby=next_due|ASC" class="sortorder"><i class="icon-sort"></i>{$lang.nextdue}</a>
                                        </th>
