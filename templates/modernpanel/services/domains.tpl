                            ...
                            <div class="pull-right">
                                <ul class="nav nav-pills tooltip-group">
                                    <li class="disabled widget_domainrenewal">
                                        <a href="{$ca_url}clientarea/domains/renew/" title="{$lang.renew_widget}"  onclick="return bulk_widget(this)" data-toggle="tooltip">
                        ...
                        <div class="affiliates-box">
                            ...
                            <table class="table styled-table fixed-table">
                                <tr>
                                    ...
                                    <th ><a href="{$ca_url}clientarea/domains/&amp;orderby=name|ASC" class="sortorder"><i class="icon-sort"></i> {$lang.domain}</a></th>
                                    <th style="width: 70px"><a href="{$ca_url}clientarea/domains/&amp;orderby=date_created|ASC"  class="sortorder"><i class="icon-sort"></i> {$lang.registrationdate}</a></th>
                                    <th style="width: 70px"><a href="{$ca_url}clientarea/domains/&amp;orderby=expires|ASC"  class="sortorder"><i class="icon-sort"></i> {$lang.expirydate}</a></th>
                                    <th style="width: 70px"><a href="{$ca_url}clientarea/domains/&amp;orderby=status|ASC"  class="sortorder"><i class="icon-sort"></i> {$lang.status}</a></th>
