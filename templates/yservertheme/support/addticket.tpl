...
<div class="spacing">
    <h4>{$lang.openticket}</h4>
</div>
<div class="brcrm">
    
    <a class="btn btn-small btn-default right" href="{$ca_url}tickets/"><i class="icon-chevron-left"></i> {$lang.back}</a>
    <span>{$lang.reportproblem}</span>
    <div class="clear"></div>
</div>
<div class="spacing">
            ...
            <tbody>
                ...
                {if !$clientdata.firstname}
                    <tr>
                        <td width="300">
                            ...
                            <input type="text" name="client_name" value="{$submit.client_name}" class="styled"/>
                        </td>
                        <td >
                            <label>{$lang.email}</label>
                            <input type="text" name="client_email" value="{$submit.client_email}" class="styled"/>
                        </td>
                    </tr>
                {else}
                    <tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <ul id="hintarea" style="display:none" class="well">
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2" >
                        <div class="form-actions">
                            ...
                            <div class="right">
                                <button type="submit" class="btn btn-success btn-large progress-button" data-horizontal="" data-style="shrink" id="submitbutton"><i class="icon-pencil"></i> {$lang.submit}</button>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </td>
