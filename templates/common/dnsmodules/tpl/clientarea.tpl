...
{if $act=='dns_manage'}
    ...
    <form action="{$ca_url}clientarea/services/{$service.slug}/{$service.id}/&act=dns_manage&domain_id={$domid}" method="POST">
        ...
        <div style="margin-top:2em">
            ...
            <a class="btnx btn_d fl" href="#" onclick="window.location='{$ca_url}clientarea/services/{$service.slug}/{$service.id}/&act=add_record&dom={$domid}&type='+$('#add_record').val();return false;">{$lang.Add}</a>
            <div class="clear"></div>
        </div>
