    ...
    {foreach from=$services item=service name=foo}
        <tr class="styled-row">
            ...
            {else}
             ...
             {/if}
            <td class="bold"> <span class="label flat-ui-label {$service.status}-label">{$lang[$service.status]}</span></td>
            ...
            <td class="btn-col">
                ...
                {if $service.status=='Active' }
                    <div class="btn-group pull-right flat-ui-dropdown-button">
                        <a href="{$ca_url}clientarea/{$action}/{$service.slug}/{$service.id}/" data-toggle="dropdown" class="btn btn-small btn-flat-primary dropdown-toggle">
                            <i class="icon-cog"></i> 
                ...
                {else}
                    <a href="{$ca_url}clientarea/{$action}/{$service.slug}/{$service.id}/" class="btn btn-small btn-flat-primary pull-right">
                        <i class="icon-cog"></i>
                    </a>
                {/if}			
            </div>
