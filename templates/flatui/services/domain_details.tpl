        ...
        <div class="wbox">
            ...
            <div  class="wbox_content" id="cartSummary">
                {foreach from=$bulkdetails item=b}
                    <a href="{$ca_url}clientarea/domains/{$b.id}/{$b.name}/"><span class="label flat-ui-label label-warning">{$b.name}</span></a>
                    {/foreach}
            </div>
        </div>
        ...
        <div class="shared-wrapper clearfix">
            ...
            <section class="shosting-container">
                ...
                <div class="padding">
                    ...
                    {else}
                        <h4>{$lang.domdetails}</h4>
                        <table class="table table-striped table-aff-center p-top">
                            <tr>
                                <td class="w30 bold">{$lang.domain}</td>
                                <td><span class="label flat-ui-label {$details.status}-label">{$lang[$details.status]}</span> <a href="http://{$details.name}" target="_blank" class="roll-link"><span data-title="{$details.name}">{$details.name}</span></a></td>
                            </tr>
                            <tr>
                            ...
                            {if $details.status == 'Active' || $details.status == 'Expired'}
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {/if}
                                        {if $allowrenew}
                                            <span class="m-icon"><i class="icon-cart inline-block"></i></span> 
                                            <a href="{$ca_url}clientarea/domains/renew/&ids[]={$details.id}" class="roll-link"><span data-title="{$lang.renewdomain}">{$lang.renewdomain}</span></a>
                                        {/if}
                                    </td>
                                </tr>
                            {/if}
                            {if $details.status == 'Active'}
                                <tr>
                                    ...
                                    <td>
                                        {if $details.reglock=='1'}<span class="label flat-ui-label On-label">{$lang.On}</span> 
                                        {else}<span class="label flat-ui-label Off-label">{$lang.Off}</span> 
                                        {/if}
                                        {foreach from=$widgets item=widg name=cst}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {if $details.autorenew=='1'}
                                            <span class="label flat-ui-label On-label">{$lang.On}</span>
                                        {else}
                                            <span class="label flat-ui-label Off-label">{$lang.Off}</span>
                                        {/if}
                                        {foreach from=$widgets item=widg name=cst}
