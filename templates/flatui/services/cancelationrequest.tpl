<article class="affiliates-container">
    <div class="pull-right">
        <a href="{$ca_url}clientarea/services/{$service.slug}/{$service.id}/" class="btn btn-back btn-flat-default"><i class="icon-chevron-left"></i>{$lang.back}</a>
    </div>
            ...
            <table class="table table-header-fix table-striped p-td">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right"> 
                            <input type="submit" value="{$lang.cancelrequest}" class="btn btn-flat-warning" />
                            <a class="btn btn-flat-primary" href="{$ca_url}clientarea/services/{$service.slug}/{$service.id}/">{$lang.backtoservice}</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
