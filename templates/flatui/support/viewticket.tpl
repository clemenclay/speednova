...
<!--EOF: FILEUPLOAD -->
<div class="row flex-container bordered-section support-content">
    <div class="span3 left-content support-left-content">
        ...
        <div class="sidebar-block">
            ...
            <form  action="" method="post">
                ...
                <button class="btn btn-flat-info btn-small" ><i class="icon-ok icon-white"></i> {$lang.resolved}</button>
	...
	{securitytoken}</form>
            ...
            <form  action="" method="post">
                ...
                <button class="btn btn-flat-info btn-small" ><i class="icon-refresh icon-white"></i> {$lang.reopen}</button>
	{securitytoken}</form>
            {/if}
        </div>
    ...
    <div class="right-content flex-box-1">
        ...
        <div class="p19">
                    <a class="right btn btn-flat-default btn-small" href="{$ca_url}tickets/"><i class="icon-chevron-left"></i> {$lang.alltickets}</a>
                <div class="clear"></div>
        </div>
        {if $ticket.status!='Closed'}
        <div class="brcrm">
                        ...
                        <tr>
                            <td><table width="100%" cellspacing="10" cellpadding="0" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="100" valign="top"><button class="btn btn-flat-success btn-large" id="submitbutton"><i class="icon-comment icon-white"></i> {$lang.submit}</button></td>
        ...
        <div class="p19">
            ...
            <div class="com-con">
                <div class="{if $reply.type=='Client'}cticket{else}aticket{/if}">
                    ...
                    <a class="right btn btn-flat-default btn-small quoter" rel="tooltip" title="{$lang.quote}" onclick="return quoteTicket('r{$reply.id}');"><i class="icon-share"></i></a>
                    {if $reply.type!='Client'}
                        {if $department.supportrating}<div class="right rating-box {if $reply.rate_date}jDisabled{/if}" id="{$reply.rating}_{$reply.id}{if $ticket.client_id==0}_{$ticket.acc_hash}{/if}"></div>
                    ...
                    <div class="comment"><div id="r{$reply.id}">{$reply.body|httptohref|nl2br}</div>
                        ...
                        <a href="?action=download&amp;id={$attachment.id}" class="attach3 roll-link">
                            <span data-title="{$attachment.org_filename}">{$attachment.org_filename}</span>
                        </a><br />
                        {/foreach}{/if}
                    </div>
                </div>
            ...
            <div class="com-con">
                <div class="{if $ticket.type=='Client'}cticket{else}aticket{/if}">
                    ...
                    <a class="right btn btn-flat-default btn-small quoter" rel="tooltip" title="{$lang.quote}" onclick="return quoteTicket('t{$ticket.id}');"><i class="icon-share"></i></a>
                    <div class="clear"></div>
