<article class="affiliates-container">
    ...
    <div class="flat-ui-tab clearfix">
        <ul id="support-tab" class="nav nav-tabs table-nav" data-filter="status">
            ...
            <li class="highlighted-tab"><a href="{$ca_url}tickets/new/"><div class="tab-left"></div> <i class="icon-plus"></i> {$lang.createnew} <div class="tab-right"></div></a></li>
        </ul>
