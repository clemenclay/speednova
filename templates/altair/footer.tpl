...
{userfooter}
   ...
   <script>{literal}
    ...
    <!-- page specific plugins -->
        <!-- d3 -->
        <script src="{$template_dir}bower_components/d3/d3.min.js"></script>
        <!-- metrics graphics (charts) -->
        <script src="{$template_dir}bower_components/metrics-graphics/dist/metricsgraphics.min.js"></script>
        <!-- chartist (charts) -->
        <script src="{$template_dir}bower_components/chartist/dist/chartist.min.js"></script>
        <!-- maplace (google maps) -->
        <script src="http://maps.google.com/maps/api/js"></script>
        <script src="{$template_dir}bower_components/maplace-js/dist/maplace.min.js"></script>
        <!-- peity (small charts) -->
        <script src="{$template_dir}bower_components/peity/jquery.peity.min.js"></script>
        <!-- easy-pie-chart (circular statistics) -->
        <script src="{$template_dir}bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
        <!-- countUp -->
        <script src="{$template_dir}bower_components/countUp.js/dist/countUp.min.js"></script>
        <!-- handlebars.js -->
        <script src="{$template_dir}bower_components/handlebars/handlebars.min.js"></script>
        <script src="{$template_dir}assets/js/custom/handlebars_helpers.min.js"></script>
        <!-- CLNDR -->
        <script src="{$template_dir}bower_components/clndr/clndr.min.js"></script>
