...
<h5 style="float:none">{$lang.promocodes} - {$lang.selectcommplan}</h5>
<div class="pt15">
...
<table class="table table-bordered table-striped">
    ...
    <div class="form-actions">
        <center>
        <button type="submit" class="clearstyle btn green-custom-btn l-btn">
        {$lang.continue}
        </button>
        </center>
          </div>
        ...
        <div class="clear clearfix">
            <div class="table-box">
                ...
                <form method="post" action="">
                    <table class="table table-striped promotional-code-table">
                        <tr>
                            <td class="w20">{$lang.vouchercode}</td>
                            <td class="w80"><input class="dark-input" readonly="readonly" type="text" value="{$plan.code}"></td>
                        </tr>
                        <tr>
                            <td>{$lang.disctype}</td>
                            <td>                
                        ...
                        <tr>
                            <td><strong>{$lang.appliesto}</strong></td>
                            <td>
                        ...
                        <tr>
                            <td>{$lang.maxusage}</td>
                            <td>
                                 <input type="checkbox" name="max_usage_limit" onclick="check_i(this)" />
                             <input size="4" name="max_usage" class="span3 config_val" disabled="disabled"/>
                             </td>
                        </tr>
                        <tr>
                            <td>{$lang.expdate}</td>
                            <td>
                                <input type="checkbox" onclick="check_i(this)" style="float:left; margin:3px 8px 0 0 !important" />
                                                <input  name="expires" class="span3 config_val haspicker" disabled="disabled"/>
                            </td>
                        </tr>
                        <tr>
                            <td>{$lang.Commission} <a class="vtip_description" title="{$lang.commissionpart}" style="display:inline"></a></td>
                            <td>
                                <input name="discount"  value="0" type="text" style="display:none" id="sfield"  variable="a" />
                                <div id="slider_margin_indicator" class="left" style="font-weight:bold; padding: 4px 0 4px 5px; min-width: 30px">
                                    {if $plan.type!='Percent'}{$affiliate.currency.sign}{/if}
                                    {$plan.max_margin}
                                    {if $plan.type=='Percent'}%{/if}
                                </div>
                                <div id="slider" class="slides left slider-admin-bg" style="margin:9px 20px 0 10px!important;float:left !important; clear:none; width:370px;">
                                    <div class="sl"></div>
                                    <div class="sr"></div>
                                </div>
                                <div id="slider_value_indicator" class="left" style="font-weight:bold; padding: 4px 5px 4px 0; min-width: 30px">
                                    {if $plan.type!='Percent'}{$affiliate.currency.sign}{/if}
                                    1
                                    {if $plan.type=='Percent'}%{/if}
                                </div>
                                <span class="left" style="padding-right: 5px; min-width: 30px">
                                    <strong>{$lang.discount}</strong> 
                                    <a class="vtip_description" title="{$lang.discountpart}" style="display:inline"></a>
                                </span>
                            </td>
                        </tr>
                    </table>
                    <div class="center-btn promo-cont-btn">
                        <input type="hidden" name="save" value="save" />
                        <button type="submit" class="clearstyle btn green-custom-btn l-btn">{$lang.addvoucher}</button>
                        {securitytoken}
                    </div>
                </form>
            </div>
...
<style type="text/css">
    ...
    .slides .sl, .slides .sr{display:none}
    .slides .ui-slider-handle{margin:-2.5px 0 0 -5px}
    .table th, .table td
</style>
{/literal}
{/if}
