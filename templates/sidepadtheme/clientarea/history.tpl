...
<h5>{$lang.userhistory}</h5>
 {if $logs}

  
<a href="{$ca_url}clientarea&action=history" id="currentlist" style="display:none" updater="#updater"></a>
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="table table-striped table-bordered fullscreen t-logs" style="margin-top:15px">
