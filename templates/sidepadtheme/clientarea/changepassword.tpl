            ...
            <div class="content-padding">
                ...
                <form class="form-horizontal password-change" action='' method='post' >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="password" autocomplete="off" name="oldpassword">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">{$lang.newpassword}:</label>
                        <div class="controls">
                            <input class="span3" type="password" autocomplete="off" name="password">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">{$lang.confirmpassword}:</label>
                        <div class="controls">
                            <input class="span3" type="password" autocomplete="off" name="password2">
                        </div>
                    </div>
