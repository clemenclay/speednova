    ...
    <td align="center">
        {if $domain.status=='Active' || $domain.status == 'Expired'}
          ...
          <ul class="dropdown-menu" style="right:0; left:auto;">
            ...
            <li><a href="{$ca_url}clientarea/domains/{$domain.id}/{$domain.name}/" style="color:#737373">{$lang.managedomain}</a></li>
            <li class="divider"></li>

            <li class="disabled widget_domainrenewal"><a href="{$ca_url}clientarea/domains/&id=renew&ids[]={$domain.id}" style="color:#737373">{$lang.renew_widget} </a></li>
            {if $domwidgets}
