    ...
    <body class="hbpopup">
        ...
        <div id="chatcontainer">
            <div class="tab" id="tab_email">
                <div id="headershelf">
                    <div class="left">{$lang.chat_welcome}</div>
                    <div class="clear"></div>
                </div>
                <div id="pickdept_container" class="form"><form action="" method="post" onsubmit="return verify_form(this)">
                        <input type="hidden" name="make" value="beginchat" />
                        {$lang.chat_welcome_content}<br/><br/>
                        ...
                        <table border="0" width="100%" class="padded_table">
                            ...
                            <tr>
                                <td align="right">
                                    <input type="submit" value="{$lang.start_chat}" />
                                </td>
                            </tr>
                        </table>
