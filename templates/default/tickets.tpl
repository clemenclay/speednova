...
{foreach from=$attachments[0] item=attachment}
  ...
  {if $replies && !empty($replies) }
      {if $department.supportrating}<link type="text/css" rel="stylesheet" href="{$template_dir}js/jRating.jquery.css" />{/if}
      <h3>{$lang.replies}</h3>
                      ...
                      <tr class="heade">
                          ...
                          <td align="right">
                              ...
                              {if $reply.type=='Admin'}
                                  ...
                                  {if !$reply.rate_date}<span class="right" style="margin-left:10px">{$lang.ratemyresponse}</span>{/if}{/if}
                              {/if}
                          </td>
                      </tr>
                      <tr>
