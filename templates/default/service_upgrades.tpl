...
{if $fieldupgrades}
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="checker">
        ...
        {/foreach}
            ...
            <tr>
                 <td colspan="3" align="right" style="border-bottom:none;"> <input type="submit" value="{$lang.continue}" style="font-weight:bold;padding:3px 2px;"/></td>
                </tr>
...
{elseif $upgrades && $upgrades!=-1}
      ...
      {/if}
		 	 ...
		 	 {/foreach}
                    ...
                    <td> <input type="submit" value="{$lang.continue}" style="font-weight:bold;padding:3px 2px;"/></td>
                </tr>
