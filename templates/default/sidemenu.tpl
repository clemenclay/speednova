...
<table border="0" width="100%" cellpadding="0" cellspacing="3">
	...
	<tr>
		...
		<input name="password" id="password" type="password" autocomplete="off" style="width:210px;" class="styled"/><div style="text-align:right"><a href="{$ca_url}root&amp;action=passreminder" style="font-size:10px;text-align:right;">{$lang.passreminder}</a></div>
		</td>		
	</tr>
