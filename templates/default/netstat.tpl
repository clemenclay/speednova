<h1 class="gears2">{$lang.netstat|capitalize}</h1>
...
<tr>
	...
	{foreach from=$servers item=server}
				...
				{if $fields.FTP}<td align="center"><img src="{$template_dir}icons/bullet_white.gif" /></td>{/if}
               {if $fields.SSH}<td align="center"><img src="{$template_dir}icons/bullet_white.gif" /></td>{/if}
			   {if $fields.HTTP}<td align="center"><img src="{$template_dir}icons/bullet_white.gif" /></td>{/if}
			   {if $fields.POP3}<td align="center"><img src="{$template_dir}icons/bullet_white.gif" /></td>{/if}
			   {if $fields.IMAP}<td align="center"><img src="{$template_dir}icons/bullet_white.gif" /></td>{/if}
			   {if $fields.MYSQL}<td align="center"><img src="{$template_dir}icons/bullet_white.gif" /></td>{/if}
