                            ...
                            <td class="{if $smarty.foreach.floop.iteration>0}bord{/if}"> <label for="field_{$k}" >
                                ...
                                {else}
                                    {if $field.field_type=='Input'}
                                        ...
                                        {/if}
                                        <input type="text" value="{$submit[$k]}" style="width: 90%;" name="{$k}" class="styled" id="field_{$k}" />
                                    {elseif $field.field_type=='Password'}
                                        <input type="password" autocomplete="off" value="" style="width: 90%;" name="{$k}" class="styled" id="field_{$k}" />
