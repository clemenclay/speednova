        ...
        <td  valign="top"  class="bordered"><div id="bodycont">
                {if $logs}
                    <form action="" method="post" id="testform" >
                        ...
                        <table cellspacing="0" cellpadding="3" border="0" width="100%" class="table glike" style="table-layout: fixed">
                            <tbody>
                                <tr>
                                    <th style="width: 60px"><a href="?cmd=gtwlog&orderby=id|ASC" class="sortorder">{$lang.idhash}</a></th>
                                    ...
                                    <th style="width: 70%">{$lang.Output}</th>
                                    <th style="width: 80px"><a href="?cmd=gtwlog&orderby=result|ASC" class="sortorder">{$lang.Result}</a></th>
                                </tr>
                            </tbody>
                            <tbody id="updater">
