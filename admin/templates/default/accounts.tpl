        ...
        <td  valign="top"  class="bordered">
            <div id="bodycont">
                ...
                {if $action=='edit' && $details}
                                ...
                                <table border="0" cellpadding="2" cellspacing="0" >
                                    <tr>
                                        ...
                                        {if !$forbidAccess.deleteServices}
                                            <a class=" menuitm menu-auto" href="#" onclick="confirm1();return false;"><span style="color:#FF0000">{$lang.Delete}</span></a>
                                        {/if}
                    ...
                    {/if}
                    <div id="confirm_ord_delete" hidden bootbox data-title="{$lang.accdelheading}" data-btnclass="btn-danger">
                        <form action="?cmd=accounts&make=delete&action=edit" method="post">
                            <p><strong>{$lang.accdeldescr}</strong></p>

                            <input type="radio" checked="checked" name="harddelete" value="true" /> <span> {$lang.deleteopt1} </span><br />
                ...
                {else}
                    <form action="" method="post" id="testform" >
                        ...
                        <div class="blu">
                            ...
                            <div class="left menubar">
                                {$lang.withselected}
                                <a class="submiter menuitm menu-auto" name="create" {if $enablequeue}queue='push'{/if}  href="#" ><span><strong>{$lang.Activate}</strong></span></a>
                                <a class="submiter menuitm menu-auto" name="suspend" {if $enablequeue}queue='push'{/if} href="#" ><span>{$lang.Suspend}</span></a>
                                <a class="submiter menuitm menu-auto" {if $enablequeue}queue='push'{/if} name="unsuspend"  href="#" ><span>{$lang.Unsuspend}</span></a>
                                <a class="submiter menuitm confirm menu-auto" name="delete" {if $enablequeue}queue='push'{/if}  href="#" ><span style="color:#FF0000">{$lang.Terminate}</span></a>
                    ...
                    <div id="confirm_ord_delete" hidden bootbox data-title="{$lang.accdelheading}" data-callback="confirmsubmit2" data-btnclass="btn-danger">

                        <form action="?cmd=accounts&make=fulldelete" method="post">
                            <p><strong>{$lang.accdeldescr}</strong></p>

                            <input type="radio" checked="checked" name="harddelete" value="true" class="cc_hard"/> {$lang.deleteopt1}<br />
