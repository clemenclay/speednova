                ...
                <table cellspacing="0" cellpadding="3" border="0" width="100%" class="table glike hover">
                    <tbody>
                        <tr>
                            ...
                            <th width="150"><a href="?cmd=logs&action=clientactivity&orderby=ip|ASC"  class="sortorder">IP</a></th>
                            <th width="150"><a href="?cmd=logs&action=clientactivity&orderby=admin_name|ASC"  class="sortorder">Logged staff</a></th>
        ...
        {if $email.headers}
            ...
            <table class="whitetable" width="99%" cellspacing="0" cellpading="0" style="table-layout:fixed; word-wrap: break-word; display:none">
                {if $email.headers|@is_array}
                    ...
                    {/foreach}
                {else}
                    <pre style="display:none; background: #eee; padding: 5px; margin: 0"><code>{$email.headers}</code></pre>
                {/if}
            </table>
        {/if}
