{if !$available}
   <h3>No new widget is available</h3>
    Widgets features can be added trough  <a href="?cmd=managemodules"><b>Extras->Plugins</b></a> and <a href="?cmd=reports"><b>Extras->Statistics & Reports</b></a><br/>
   <br/> Make sure to check/activate following free widgets/plugins:
    <ul>
    ...
    <div class="form-group">
        <label for="exampleInputName2">Activate Widget: </label>
