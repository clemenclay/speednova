{if $self_check}
        ...
        <table class="whitetable fs11 statustables" width="100%" cellspacing="0" cellpadding="3">
            <tr class="odd">
                ...
                <td width="12%">{if $self_check.php.ok}<b>{$self_check.php.version}</b>{else}<b class="err vtip_description" title="Error: HostBill requires PHP 5.6+, with lower versions it may not work stable.">{$self_check.php.version}</b>{/if}</td>
