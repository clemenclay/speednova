    ...
    <form name="" action="" method="post">
        ...
        <div class="lighterblue2" >
            <table border=0 width="100%" cellpadding="6" cellspacing="0" style="padding:5px"> 
                ...
                <tr>
                    <td colspan="4" align="center">
                        <input type="submit" style="font-weight:bold" value="{$lang.savechanges}" class="btn btn-primary"/> <span class="orspace">{$lang.Or} <a href="?cmd=editadmins" class="editbtn">{$lang.Cancel}</a></span>
                    </td>
                </tr>
            </table>
        </div>
