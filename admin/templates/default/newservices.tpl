                ...
                <div class="list-2">
                    <div class="subm1 haveitems">
                        <ul >
                            ...
                            <li ><a href="#" onclick="$(this).hide();
                                    ...
                                    {if $product.stock == 0}
                                <li ><a href="#" onclick="$(this).hide();
                                        $('.stockcontrol').ShowNicely().find('input[name=\'stock\']').attr('checked', 'checked');"><span >{$lang.enable_stock}</span></a></li>
                                    {/if}
                    ...
                    <div class="subm1 haveitems" style="display:none">
                        <ul >
                            ...
                            {if $otherproducts} <li><a  href="#"   id="premadeautomationswitch" onclick="$('#premadeautomation').show();
                                    $(this).hide();
                                    return false"><span class="addsth" >{$lang.copyautomation}</span></a></li>{/if}
                            </ul>
                        </div>
                        <div class="subm1" style="display:none"></div>
                    ...
                    <div class="imp_msg" style="margin-top:10px;{if $product.visible!='0'}display:none{/if}" id="hiddenmsg">
                    ...
                    <div class="imp_msg" style="margin-top:10px;{if $product.visible!=-1}display:none{/if}" id="archivemsg">
                        <strong>Note: This product is archived, it is not available in listsings and can't be purchased.</strong> 
                        <a class="editbtn" onclick=" $('#prod_visibility').val('1');
                                $('#archivemsg').hide();
                                saveProductFull();
                ...
                <td valign="top" class="nicers" style="border:none;" colspan="2">
                    <table width="100%" cellspacing="0" cellpadding="6">
                        ...
                        <tr  class="stockcontrol" {if $product.stock == 0}style="display:none"{/if}>
                            ...
                            <td>
                                <input type="checkbox" name="stock" value="1" {if $product.stock > 0}checked="checked"{/if} onclick="if (this.checked)
                                            $('#sstoc').show();
                                        else
                                            $('#sstoc').hide();"/>
                                <div class="p5" id="sstoc" style="margin-top: 10px; border: 1px solid rgb(204, 204, 204);">
                                    <div>
                                        {$lang.quantityinstock} <input type="text" value="{$product.stock}" size="4" name="qty" class="inp"/> (Used {$product.qty})
                                    </div>
                                    <div>
                                        <input type="hidden" name="config[ReturnToStockOnTerminate]" value="0" />
                                        <input type="checkbox" value="1" name="config[ReturnToStockOnTerminate]" {if $configuration.ReturnToStockOnTerminate == '1'}checked="checked"{/if} />
                                        ...
                                        <td>
                                            <select name="module" onchange="loadMod(this)" id="modulepicker" class="inp left modulepicker" style="width:200px;">
                                                ...
                                                {foreach from=$modules item=mod}{if $mod.id!='-1'}
                                                        ...
                                                        <a onclick="connectMoreApps(this);
                                                                return false;" class="new_control right" href="#"><span class="addsth">Connect more apps</span></a>
                                                ...
                                                <tr id="premadeautomation" style="display:none">
                                                    ...
                                                    <tr class="odd"> <td align="right" valign="top" width="200"><strong>{$lang.auto_create}</strong></td>
                                                        ...
                                                        <td id="automateoptions">
                                                            <input type="radio" value="0" name="autosetup2" {if $product.autosetup=='0' || $product.autosetup=='1'}checked="checked"{/if} 
                                                                   id="autooff" onclick="$('#autosetup_opt').hide();
                                                                           $('#autooff_').click();"/>
                                                            <label for="autooff"><b>{$lang.no}</b></label>

                                                            <input type="radio"  value="1" name="autosetup2" {if $product.autosetup!='0' && $product.autosetup!='1'}checked="checked"{/if} 
                                                                   id="autoon" onclick="$('#autosetup_opt').ShowNicely();
                                                                           $('#autoon_').click();"/>
                                                            <label for="autoon"><b>{$lang.yes}</b></label>

                                                            <div class="p5" id="autosetup_opt" style="{if $product.autosetup=='0' || $product.autosetup=='1'}display:none;{/if}margin-top:10px;border:#ccc 1px solid;" >
                                                                <input type="radio" style="display:none" {if $product.autosetup=='0' || $product.autosetup=='1'}checked="checked"{/if} value="0" name="autosetup" id="autooff_"/>
                                                                <input type="radio" {if $product.autosetup=='3'}checked="checked"{/if} value="3" name="autosetup" id="autosetup3"/> 
                                                                <label for="autosetup3">{$lang.whenorderplaced}</label><br />
                                                                <input type="radio" {if $product.autosetup=='2'}checked="checked"{/if} value="2" name="autosetup" id="autoon_"/> 
                                                                ...
                                                                <input type="radio" {if $product.autosetup=='4'}checked="checked"{/if} value="4" name="autosetup" id="autosetup4"/> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" {if $configuration.EnableAutoSuspension == 'off'}checked="checked"{/if} 
                                                                   name="config[EnableAutoSuspension]" value="off" onclick="$('#suspension_options').hide();" 
                                                                   id="suspend_off"/>
                                                            <label  for="suspend_off"><b>{$lang.no}</b></label>

                                                            <input type="radio" {if $configuration.EnableAutoSuspension == 'on'}checked="checked"{/if} 
                                                                   name="config[EnableAutoSuspension]" value="on" onclick="$('#suspension_options').ShowNicely()" 
                                                                   id="suspend_on"/>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <input type="radio" {if $configuration.EnableAutoUnSuspension == 'off'}checked="checked"{/if} 
                                                                   name="config[EnableAutoUnSuspension]" value="off" onclick="$('#unsuspension_options').hide();" 
                                                                   id="unsuspend_off"/>
                                                            <label  for="unsuspend_off"><b>{$lang.no}</b></label>
                                                            <input type="radio" {if $configuration.EnableAutoUnSuspension == 'on'}checked="checked"{/if} 
                                                                   name="config[EnableAutoUnSuspension]" value="on" onclick="$('#unsuspension_options').ShowNicely();" 
                                                                   id="unsuspend_on"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" {if $configuration.EnableAutoTermination == 'off'}checked="checked"{/if} 
                                                                   name="config[EnableAutoTermination]" value="off" onclick="$('#termination_options').hide();" 
                                                                   id="termination_off"/>
                                                            <label  for="termination_off"><b>{$lang.no}</b></label>

                                                            <input type="radio" {if $configuration.EnableAutoTermination == 'on'}checked="checked"{/if} 
                                                                   name="config[EnableAutoTermination]" value="on" onclick="$('#termination_options').ShowNicely();" 
                                                                   id="termination_on"/>
                                                            ...
                                                            <div class="p5" id="termination_options" style="{if $configuration.EnableAutoTermination == 'off'}display:none;{/if}margin-top:10px;border:#ccc 1px solid;" >
                                                                ...
                                                                <br />
                                                                <input type="radio" {if $configuration.AutoCancelUnpaidInvoices == 'off'}checked="checked"{/if} name="config[AutoCancelUnpaidInvoices]" value="off" /> <b>No</b>
                                                                <input type="radio" value="on" name="config[AutoCancelUnpaidInvoices]" {if $configuration.AutoCancelUnpaidInvoices == 'on'}checked="checked"{/if} /> <b>Yes</b>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <p class="p5">
                                                                ...
                                                                <span class="prorata">
                                                                    Invoice will be generated <span class="pror-gendate"></span> day of the month.
                                                                </span>
                                                            </p>                                          
                                                        </td>
                                                    ...
                                                    <tr class="odd">
                                                        <td align="right" style="vertical-align: top"><strong>Advanced due date settings </strong>
                                                        </td>
                                                        <td>
                                                            <input type="radio" {if $configuration.AdvancedDueDate == 'off'}checked="checked"{/if}   
                                                                   name="config[AdvancedDueDate]" value="off"  onclick="$('#advanceddue_options').hide();" id="advanceddue_off"/>
                                                            <label  for="advanceddue_off"><b>{$lang.no}</b></label>

                                                            <input type="radio" {if $configuration.AdvancedDueDate == 'on'}checked="checked"{/if}  
                                                                   name="config[AdvancedDueDate]" onclick="$('#advanceddue_options').ShowNicely();" id="advanceddue_on"/>
                                                            ...
                                                            <div class="p5" id="advanceddue_options" style="{if $configuration.AdvancedDueDate == 'off'}display:none;{/if}margin-top:10px;border:#ccc 1px solid;" >
                                                                ...
                                                                <p class="move-due-date">
                                                                    ...
                                                                    days into future for recurring <span class="prorata">pro-rata</span> invoices.
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="odd">
                                                        <td width="200"  valign="top" align="right"><strong>Adjust Initial Period</strong></td>
                                                        <td>
                                                            <input type="radio" {if $configuration.AdsjustDatesOnCreation == 'off'}checked="checked"{/if} 
                                                                   name="config[AdsjustDatesOnCreation]" value="off" />
                                                            <label  for="unsuspend_off"><b>{$lang.no}</b></label>
                                                            <input type="radio" {if $configuration.AdsjustDatesOnCreation == 'on'}checked="checked"{/if} 
                                                                   name="config[AdsjustDatesOnCreation]" value="on" />
                                                            <label  for="unsuspend_on"><b>{$lang.yes}</b></label>
                                                            <div class="p5" id="AdsjustDatesOnCreation_options" >
                                                                Adjust dates after initial provisioning so that client gets his service for full period of time in case he pays few days afer order.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" {if $configuration.AutoProcessCancellations == 'off'}checked="checked"{/if} 
                                                                   name="config[AutoProcessCancellations]" value="off" onclick="$('#cancelation_options').hide();" id="cancelation_off"/>
                                                            <label  for="cancelation_off"><b>{$lang.no}</b></label>
                                                            <input type="radio" {if $configuration.AutoProcessCancellations == 'on'}checked="checked"{/if} 
                                                                   name="config[AutoProcessCancellations]" value="on" onclick="$('#cancelation_options').show();" id="cancelation_on"/>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <input type="radio" {if $configuration.SendPaymentReminderEmails == 'off'}checked="checked"{/if}   
                                                                   name="config[SendPaymentReminderEmails]" value="off"  onclick="$('#reminder_options').hide();" id="reminder_off"/>
                                                            <label  for="reminder_off"><b>{$lang.no}</b></label>

                                                            <input type="radio" {if $configuration.SendPaymentReminderEmails == 'on'}checked="checked"{/if}  
                                                                   name="config[SendPaymentReminderEmails]" onclick="$('#reminder_options').ShowNicely();" id="reminder_on"/>
                                                            ...
                                                            <div class="p5" id="reminder_options" style="{if $configuration.SendPaymentReminderEmails == 'off'}display:none;{/if}margin-top:10px;border:#ccc 1px solid;" >
                                                                ...
                                                                <span>
                                                                    <input type="checkbox" value="1" {if $configuration.InvoiceUnpaidReminder>0}checked="checked"{/if} onclick="check_i(this)" />
                                                                ...
                                                                <span>
                                                                    <input type="checkbox" value="1" {if $configuration.1OverdueReminder>0}checked="checked"{/if} onclick="check_i(this)" />
                                                                    <input type="text" size="3" class="config_val  inp" 
                                                                           {if $configuration.1OverdueReminder<=0}value="0" disabled="disabled"{else}value="{$configuration.1OverdueReminder}"{/if} 
                                                                           name="config[1OverdueReminder]"/>
                                                                </span>
                                                                <span>
                                                                    <input type="checkbox" value="1" {if $configuration.2OverdueReminder>0}checked="checked"{/if} onclick="check_i(this)" />
                                                                    <input type="text" size="3" class="config_val inp" 
                                                                           {if $configuration.2OverdueReminder<=0}value="0" disabled="disabled"{else}value="{$configuration.2OverdueReminder}"{/if} 
                                                                           name="config[2OverdueReminder]"/>
                                                                </span>
                                                                <span>
                                                                    <input type="checkbox" value="1" {if $configuration.3OverdueReminder>0}checked="checked"{/if} onclick="check_i(this)" />
                                                                    <input type="text" size="3" class="config_val  inp" 
                                                                           {if $configuration.3OverdueReminder<=0}value="0" disabled="disabled"{else}value="{$configuration.3OverdueReminder}"{/if} 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" {if $configuration.LateFeeType == '0'}checked="checked"{/if} 
                                                                   name="config[LateFeeType_sw]" value="0"  onclick="$('#latefee_options').hide();" id="latefee_off"/>
                                                            <label  for="latefee_off"><b>{$lang.no}</b></label>
                                                            <input type="radio" {if $configuration.LateFeeType != '0'}checked="checked"{/if} 
                                                                   name="config[LateFeeType_sw]" value="1" onclick="$('#latefee_options').ShowNicely();" id="latefee_on"/>
                                                            ...
                                                            <div class="p5" id="latefee_options" style="{if $configuration.LateFeeType == '0'}display:none;{/if}margin-top:10px;border:#ccc 1px solid;" >
                                                                ...
                                                                <input size="1" class="inp config_val"  value="{$configuration.LateFeeValue}" name="config[LateFeeValue]"/>
                                                                ...
                                                                <input type="text" size="3" value="{$configuration.AddLateFeeAfter}" name="config[AddLateFeeAfter]" class="config_val inp" /> 
                                                                {$lang.LateFeeType2x} 
                                                                <br />
                                                            </div>
                                                        </td>
                                                            ...
                                                            <tr id="addonseditor" >
                                                                    ...
                                                                    {if $addons.addons || $addons.applied}
                                                                        {if $addons.applied}<div class="p5">
                                                                                <table border="0" cellpadding="6" cellspacing="0" width="100%" >
                                                                                    ...
                                                                                    <div style="padding:10px 4px">
                                                                                        {if $addons.available}<a href="#" class="new_control" onclick="$(this).hide();
                                                                                                $('#addnew_addons').ShowNicely();
                                                                                                return false;"  id="addnew_addon_btn"><span class="addsth" >{$lang.assign_new_addons}</span></a>{/if}
                                                                                        </div>
                                                                                    {else}
                                                                        ...
                                                                        <tbody id="domainsopt"  style="display:none" class="components_content" >
                                                                            ...
                                                                            <tr class="odd">
                                                                                ...
                                                                                <td >
                                                                                    <input type="checkbox" name="hostname" value="1" {if $product.hostname=='1'}checked="checked"{/if} /> {$lang.require_hostname} <br />
                                                                                    Validation
                                                                                    <select name="p_options[]">
                                                                                        <option value="0">Do not validate provided hostname</option>
                                                                                        <option value="2" {if $product.p_options & 2}selected{/if}>Check if provided hostname is valid DNS name</option>
                                                                                        <option value="4" {if $product.p_options & 4}selected{/if}>Check if provided hostname is valid Domain name (example.com)</option>
                                                                                        <option value="8" {if $product.p_options & 8}selected{/if}>Check if provided hostname is valid FQDN (server.example.com)</option>
                                                                                    </select>
                                                                                </td>
                                                                            </tr>

                                                                            <tr id="domain_options_container" >
                                                                                <td  align="right"><b>{$lang.offerdomains}</b></td><td>
                                                                                    <input type="radio" value="1" {if $product.domain_options=='1'}checked="checked"{/if} name="domain_options" id="domain_options" onclick="$('#domain_options_blank_state').hide();
                                                                                            $('.showdomopt').toggle();"/> <label for="domain_options">{$lang.yes}</label>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="2">
                                                                                                ...
                                                                                                {if $product.subdomain==''}<a href="#" onclick="$(this).hide();
                                                                                                        $('#off_sub').show();
                                                                                                        return false;"><strong>{$lang.addsubdomain}</strong></a>{/if}<input type="text"  value="{$product.subdomain}" name="subdomain" style="width:98%;{if $product.subdomain==''}display:none;{/if}"  class="inp" id="off_sub" />
                                                                                                </td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <div class="blank_state_smaller blank_domains">
                                                                                                <div class="blank_info">
                                                                                                    ...
                                                                                                    <a  href="#" class="new_control"  onclick="$('#subproducts_options_container').show();
                                                                                                            ...
                                                                                                            return false;
                                                                                                            return false" ><span class="addsth" ><strong>Enable Sub-products</strong></span></a>
                                                                                                    <div class="clear"></div>
                                                                ...
                                                                <tbody style="display:none"  class="sectioncontent">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="radio" {if $product.client_limit == '0'}checked="checked"{/if} name="product_limit_customer" value="off" onclick="$('#limit_options').hide();
                                                                    ...
                                                                    <tr>
                                                                        <td width="200" valign="top" align="right"><strong>Block Cancelations</strong></td>
                                                                        <td>
                                                                            <input type="radio" {if !($product.p_options & 1) }checked="checked"{/if} name="p_options[1]" value="0"/><label  ><b>{$lang.no}</b></label>
                                                                            <input type="radio" {if  $product.p_options & 1  }checked="checked"{/if} name="p_options[1]" value="1"  /><label  ><b>{$lang.yes}</b></label>
