            ...
            <div id="bodycont">
                ...
                {else}
                    <form action="{if $action=='asticket'}?cmd=sendmessage&action=asticket{else}?cmd=sendmessage{/if}" method="post" id="massform">
                        ...
                        <div class="blu">
                            {if $action=='asticket'}
                                <input type="submit" name="tickets" value="Create Tickets" style="font-weight:bold" class="btn btn-primary btn-sm" onclick="return send_email();"/>
                            {elseif !$sms}
                                <input type="submit" name="send" value="{$lang.SendMessage}" style="font-weight:bold" class="btn btn-primary btn-sm"  onclick="return send_email();"/>
                            {else}
                                <input type="submit" name="send" value="Send SMS" class="btn btn-primary btn-sm"   style="font-weight:bold"/>
                        ...
                        <div class="blu">
                            {if $action=='asticket'}
                                <input type="submit" name="tickets" value="Create Tickets" class="btn btn-primary btn-sm"  style="font-weight:bold" onclick="return send_email();"/>
                            {elseif !$sms}
                                <input type="submit" name="send" value="{$lang.SendMessage}"  class="btn btn-primary btn-sm"  style="font-weight:bold" onclick="return send_email();"/>
                                {else}
                                <input type="submit" name="send" value="Send SMS" class="btn btn-primary btn-sm"  style="font-weight:bold"/>
