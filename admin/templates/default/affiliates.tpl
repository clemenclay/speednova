...
<table border="0" cellspacing="0" cellpadding="0" width="100%" id="content_tb" {if $currentfilter}class="searchon"{/if}>
    ...
    <tr>
        <td class="leftNav">
            ...
            <br />
            <a href="?cmd=affiliates"  class="tstyled  {if $action=='affiliate' || $action=='withdrawals' || $action=='queue' || $action=='commissions' || $action=='default' || !$action}selected{/if}">{$lang.Affiliates}</a>
