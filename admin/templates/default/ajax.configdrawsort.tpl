                        ...
                        <td align="right" valign="top">
                            <div style="padding:5px 0px;">
                                {if $field.type.info.pricing}
                                    <a onclick="$('#fpricing_{$k}').toggle();$(this).toggleClass('activated');return false;" title="{$lang.enablepricing}" class="menuitm menu-auto" href="#">
                                        <span class="billsth">&nbsp;</span>
                                    </a>
                                {/if}
                                <a onclick="$('#fvar_{$k}').toggle();$(this).toggleClass('activated');return false;" title="Advanced options" class="menuitm menu-auto" href="#">
                                    <span class="gear">&nbsp;</span>
                                </a>
                                <a onclick="return deleteItem(this)" title="delete" class="menuitm menu-auto" href="?cmd=configfields&action=deleteitem&id={$item.id}">
