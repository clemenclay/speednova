                ...
                <form method="post" action="">
                    ...
                    <div class="blu"> <a href="?cmd=annoucements" class="tload2" data-pjax><strong>&laquo; {$lang.backtonews}</strong></a>
                        <input type="submit" name="submit" style="font-weight:bold" value="{$lang.addnews}" class="btn btn-primary btn-sm"/>
                        <input type="button" onclick="window.location='?cmd=annoucements'" value="{$lang.Cancel}"  class="btn btn-default btn-sm"/>
                    </div>
                    {securitytoken}</form>
...
{/foreach}{if $showall}
				...
				<div class="blu">
                    <input type="button" value="{$lang.createnewnews}" class="linkDirectly btn btn-success btn-sm" href="?cmd=annoucements&action=add" />
					<div class="right"><div class="pagination"></div></div>
                </div>
                {/if}
                {else}
