<div id="newshelfnav" class="newhorizontalnav">
    <div class="list-1" style="border:solid 1px #ccc;border-bottom:none">
        <ul>
            <li class="">
...
<div class="p5" style="border-top:none">
    <a href="#"   onclick="return addNewProfile();" >Add new profile</a>
    &nbsp;&nbsp;&nbsp;<a href="#"   onclick="$('.showhelp').show();return false;" >Show help</a>
</div>
