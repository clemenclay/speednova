                        ...
                        {foreach from=$config item=field}
                            <li style="background:#ffffff"><div style="border-bottom:solid 1px #ddd;">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="5">
                                        <tr>
                                            <td valign="top" width="140"><div style="padding:10px 0px;"><input type="hidden" name="sortc[]" value="{$field.id}" class="ser"/><a name="f{$field.id}"></a>
                                                    ...
                                                    <a href="?cmd=configfields&make=delete&id={$field.id}&product_id={$product_id}" class="menuitm menu-auto" title="{$lang.delete}" 
                                            ...
                                            <td >
                                                ...
                                                {if $field.variable}
                                                    <input type="hidden" id="configvar_{$field.variable|regex_replace:'/[^a-z0-9A-Z_-]/':''}" value="{$field.id}"/>
                                                    <script type="text/javascript">
                                                        {literal}
        ...
        {else}
            ...
            <div class="blank_state_smaller blank_forms">
                <div class="blank_info">
                    ...
                    <div class="clear"></div>
                    <br/>
                    <a  href="#" class="new_control"  onclick="return addCustomFieldForm({$product_id});" ><span class="addsth" ><strong>{$lang.assign_custom_opt}</strong></span></a> <span class="orspace">{$lang.Or}</span> <a href="#"  class="new_control" onclick="$('#importforms').show();
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td width="140" id="s_menu" style="" valign="top">
                                        <div id="lefthandmenu">
                                            ...
                                            {foreach from=$field.type.templates item=tp key=tpname}
                                                <a class="tchoice" href="#{$tpname}">{$tpname}</a>
                                            {/foreach}
                                    ...
                                    <td class="conv_content form"  valign="top">
                                            ...
                                            <div class="tabb" style="display:none">
                                                ...
                                                {foreach from=$field.items item=item key=k}
                                                    <div class="formbilling formbilling-head" {if !$field.items[0].pricing_enabled}style="display: none"{/if}>
                                                        <a href="#{$paytypeform}" {if !$item.paytype || $item.paytype == $paytypeform}class="active"{/if} onclick="formbilling(this);
                                                                return false">Regular</a>
                                                        {foreach from=$field.type.info.adformbilling item=formbilling}
                                                            <a href="#{$formbilling}" {if $item.paytype == $formbilling}class="active"{/if} 
                                        ...
                                        <div class="tabb" style="display:none">
                                            <h3>
                                                <img src="../includes/libs/configoptions/{$field.type.type}/{$field.type.type}_thumb2.png" alt="" 
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                    <tr>
                                                        <td width="40%">
                                                            ...
                                                            <input id="check-admin" type="checkbox" name="options[]" value="4" {if $field.options & 4}checked="checked"{/if} onclick="if ($(this).is(':checked'))
