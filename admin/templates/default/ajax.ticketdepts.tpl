        ...
        <script type="text/javascript">
            $(function () {
                ...
                $('.from-name').on('change', function () {
                    ...
                    if (!self.is(':checked'))
                        return;
                    self.nextAll('.form-group').find('input').prop('disabled', val);
                }).trigger('change');
            });
        </script>
        <style type="text/css">
            ...
            .pipe-label{color: #888888;
                        display: block;
                        padding: 5px 0;}
            .import-mail .poptest {overflow: hidden;}
            .poptest .result {padding: 1em; display: block;}
            ...
            .import-mail .poptest .result:empty{
                display: none;
            }
            .smtpform,
            .popform{
            ...
            <table width="100%" cellspacing="0" cellpadding="6" border="0">
                <tbody class="sectioncontent">
                    <tr>
                        ...
                        <td >
                            {*}<input type="text" value="{$submit.name}" size="50" name="name"  class="inp" style="font-weight:bold;"/>{*}
                            {hbinput value=$submit._name style="font-weight:bold;" class="inp" size="50" name="name"}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td >
                            ...
                            <div  {if !$submit.description} style="display:none"{/if} >
                                ...
                                {hbwysiwyg value=$submit.description style="width:99%;" class="inp" cols="100" rows="6" name="description"}
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    {foreach from=$submit.importmails item=mail key=key}
                        {if $mail.email}
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="editbtn" onclick="editImportMail(this);
                                            return false">Edit</a>
                                    {if $key>0}<a href="#" class="editbtn" onclick="removeImportMail(this);
                                            return false">Delete</a>{/if}
                                    </td>
                                </tr>
                            {/if}
                            <tr {if $key==0}id="mainImportEmail"{/if} class="import-mail-row" {if $mail.email}style="display: none"{/if}>
                                ...
                                <td >
                                    ...
                                    <a class="new_control clear" href="#" onclick="testImportConfiguration($(this).prev().val(), this);
                                            return false;">
                                        <span class="wizard">{$lang.test_configuration}</span>
                                    </a>
                                </td>
                                <td>{if $key>0}<a href="#" class="editbtn" onclick="removeImportMail(this);
                                        return false">Delete</a>{/if}</td>
                            </tr>
                            <tr id="popform"  {if $mail.email || $mail.method!='POP' || !$mail.method}style="display:none"{/if}>
                                <td colspan="3">
                                    <div class="lighterblue popform" >
                                        <div>
                        ...
                        <tbody class="sectioncontent" style="display:none">
                            <tr>
                                <td align="right" width="160"><strong>From Name</strong></td>
                                <td >
                                    <input type="radio" value="1" name="from-name" class="from-name" {if !$submit.sendername}checked{/if}> 
                                    Use Company Name and Department name for notifications
                                    <br />
                                    <input type="radio" value="0" name="from-name" class="from-name" {if $submit.sendername}checked{/if}> 
                                    Custom name:
                            ...
                            <tr class="sendmailform" {if $submit.sendmethod!='3'}style="display:none"{/if}>
                                ...
                                <td>
                                    ...
                                    <div class="lighterblue smtpform">
                                        <div>
                                            <label for="smtp_email">SMTP Email</label> 
                                            <input type="text" id="smtp_email" value="{$submit.smtpemail}" size="40" name="smtpemail" class="inp"/>
                                        </div>
                                        <div>
                                            <label for="smtp_host">SMTP {$lang.Hostname}</label> 
                        ...
                        <tbody class="sectioncontent" style="display:none">
                            ...
                            <tr class="bordme">
                                ...
                                <td >
                                    <input type="radio" name="ticketnotifies" value="3" {if $submit.ticketnotifies=='3'}checked="checked"{/if}/> 
                                    <strong>High</strong>, Send notification to client, subscribed staff and all staff members in this department.
                                    <br />
                                    <input type="radio" name="ticketnotifies" value="1" {if $submit.ticketnotifies=='1' || !$submit}checked="checked"{/if}/> 
                                    <strong>Medium</strong>, Send notification to client and entitled staff members
                                    <a href="#" class="vtip_description" title="Notifications for assigned tickets will be sent only to assigned & subscribed support staff, notifications for unassigned tickets will be sent to all staff members"></a> 
                                    <br />
                                    <input type="radio" name="ticketnotifies" value="2" {if $submit.ticketnotifies=='2'}checked="checked"{/if}/> 
                                    <strong>Low</strong>, Send notification to client and only to staff member subscribed to related ticket 
                                    <a href="#" class="vtip_description" title="Emails to staff members won't be sent if ticket is not assigned"></a>
                                    <br />
                                    <input type="radio" name="ticketnotifies" value="0" {if $submit.ticketnotifies=='0'}checked="checked"{/if}/> 
                            ...
                            <tr class="bordme">
                                ...
                                <td >
                                    <input type="radio" name="allowedsub"  value="0" {if $submit.allowedsub=='0' || !$submit}checked="checked"{/if}/> {$lang.allowedsuball}<br />
                                    <input type="radio" name="allowedsub"  value="1" {if $submit.allowedsub=='1'}checked="checked"{/if}/> {$lang.deptonlyforregistered}<br />
                                    <input type="radio" name="allowedsub"  value="2" {if $submit.allowedsub=='2'}checked="checked"{/if}/> Only staff members can open new trouble tickets in this department
                                </td>
                            </tr>
                            <tr class="bordme">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" align="center" >
                                    {if $action=='edit'}
                                        <input type="submit" value="{$lang.savechanges}" style="font-weight:bold" class="btn btn-primary"/> <span class="orspace">{$lang.Or}
                                            <a href="?cmd=ticketdepts" class="editbtn">{$lang.Cancel}</a></span>
                                        <input type="hidden" name="make" value="edit"/>
                                    {else}	
                                        <input type="submit" value="{$lang.adddepartment}" style="font-weight:bold" class="btn btn-primary"/> <span class="orspace">{$lang.Or}
                                            <a href="?cmd=ticketdepts" class="editbtn">{$lang.Cancel}</a></span>
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="3" border="0" class="table glike">
                                                <tr class="nobordera">
                                                    ...
                                                    <td width="28%" valign="top"><a href="?cmd=ticketdepts&action=edit&id={$dept.id}"><strong>{$dept.name}</strong></a>
                                                        <div style="font-size:80%;padding-left:10px;">&#8594; Assigned To: {foreach from=$admins item=adm name=adminloop}{if $dept.assigned_admins[$adm.id]}{if !$smarty.foreach.adminloop.first}, {/if}{$adm.username}{/if}{/foreach}
                                                            {if !$dept.assigned_admins}<b>No staff member assigned</b>{/if}</div>
                                                    </td>
                                    ...
                                    function testConfiguration(type) {
                                        if (type === undefined || type == 'PHP') {
                                            ...
                                            ajax_update('?cmd=ticketdepts&action=test_smtp', {
                                                'from': $('input[name="senderemail"]').val(),
                                                'email': $('input[name="smtpemail"]').val(),
