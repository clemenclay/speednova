...
<div style="padding:15px;">
	...
	{foreach from=$emails.All item=email  name=fr}{if $email.for!='Admin'}
                           ...
                           {/if} {/foreach}
                            <tr >
                                <th colspan="4" align="left"><a href="?cmd=emailtemplates&action=add&group=Mobile&for=Client"  class="editbtn">{$lang.addnewtemplate}</a></th>
                            </tr>
	...
	{foreach from=$emails.All item=email  name=fr}{if $email.for=='Admin'}
                           ...
                           {/if} {/foreach}
                            <tr >
                                <th colspan="4" align="left"><a href="?cmd=emailtemplates&action=add&group=Mobile&for=Admin"  class="editbtn">{$lang.addnewtemplate}</a></th>
                            </tr>
