...
{if !$items}
    <em>This client does not have any Invoice Items in queue yet</em>
{else}
                ...
                <div style="border-bottom:solid 1px #ddd;">
                    <table width="100%" cellspacing="0" cellpadding="5" border="0">
                        <tr>
                            ...
                            <td width="20" >
                                <a onclick=" if(confirm('Are you sure you want to delete this item?')) return itemqueue.del('{$f.id}'); return false;" class="delbtn" href="#">delete</a>
                            </td>
                        </tr>
                    </table>
                </div>
...
<div id="itemqueueform" style="display:none; background: white">
    <div style="padding: 5px">
        ...
        <table cellpadding="5" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <td><input type="text" name="queueitem[description]" class="inp" placeholder="Item name and description"  style="width:370px;"/></td>
            </tr>
            <tr>
                <td align="right" width="160"><strong>{$lang.Note}</strong></td>
                <td><textarea name="queueitem[note]" class="inp" placeholder="Short note about this item. It will be copied to invoice notes" style="width:370px; height:4em"></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right"  ><strong>Add to next invoice for service</strong></td>
                <td >
    ...
    <div style=" background: #272727; box-shadow: 0 -1px 2px rgba(0, 0, 0, 0.3); color: #FFFFFF;  padding: 11px 11px 10px; clear:both">
...
<a href="#" class="menuitm right greenbtn" onclick="return itemqueue.form()"><span>Add Item</span></a>
{/if}
<div class="clear"></div>
{literal}
    <script type="text/javascript">
                    var itemqueue = {
                        form: function() {
                            ...
                            $.facebox({div: '#itemqueueform', width: 900, opacity: 0.5, nofooter: true, addclass: 'modernfacebox'});
                            return false;
                        },
                        add: function() {
                        var errors = false;
