...
<table border="0" cellpadding="10" width="100%" cellspacing="0"  class="sectioncontenttable">
    ...
    {/if}
            ...
            <tr class="bordme">
                <td width="205" align="right" valign="middle">
                    <b>Show account #ID: <a class="vtip_description" title="When enabled invoice lines will show account ID for related entries"></a></b><br/>
                </td>
                <td colspan="3">
                <input type="checkbox" name="InvoiceShowAccountId" value="1" {if $configuration.InvoiceShowAccountId}checked="checked"{/if} />

            </td>

    <tr class="bordme">
        <td width="205" align="right" valign="middle">
            <b>Period on recurring invoices: <a class="vtip_description" title="Invoices issued for accounts gets period added to them by default. Invoices issued from Invoices->Recurring can also have period added when this feature is enabled"></a></b><br/>
        </td>
        <td colspan="3">
            <input type="checkbox" name="RecurringAddPeriod" value="on" {if $configuration.RecurringAddPeriod=='on'}checked="checked"{/if} />

        </td>
    </tr>
    <tr class="bordme">
        <td width="205" align="right" valign="middle">
            <b>Period on upgrade invoices: <a class="vtip_description" title="Invoices issued for account upgrades does not have  period added to them by default. "></a></b><br/>
        </td>
        <td colspan="3">
            <input type="checkbox" name="UpgradesAddPeriod" value="on" {if $configuration.UpgradesAddPeriod=='on'}checked="checked"{/if} />
