        ...
        <tbody class="sectioncontent cpadding">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="AffCheckServices" {if $configuration.AffCheckServices}checked="checked"{/if} value="1" /> Accept only if all services related to refereed order are active.
                </td>
            </tr>
            <tr>
