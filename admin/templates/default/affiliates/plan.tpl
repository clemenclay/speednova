<form action="" method="post">
    ...
    <div class="lighterblue2">
        <table border="0" cellpadding="6" cellspacing="0" width="100%">
            ...
            <tr>
                <td align="right" style="vertical-align: top; line-height: 25px"><strong>{$lang.commission} {$lang.rate}</strong></td>
                <td>
                    ...
                    <div id="ot-rates">
                        {foreach from=$commision.otrates|default:$otrate item=rate key=k name=otrates}
                            <div class="ot-rate" data-key="{$k}" >
                                ...
                                after <input class="inp" size="3" name="ot[{$k}][after]" value="{$rate.after}"/> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" size="3" value="{$commision.autoassign|default:1}" name="autoassign" class="inp" id="auto-assign"/>
                    approved orders.
                </td>
            </tr>
            <tr>
