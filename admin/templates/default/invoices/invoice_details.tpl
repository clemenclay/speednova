                    ...
                    <table border="0" width="300" cellspacing="3" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td width="200" align="left">
                                <span class="livemode">{if $invoice.recurring.duedays}{$invoice.recurring.duedays}{else}Default - {$automation.duedays}{/if} day(s)</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="100" align="right" class="light">Pay Before Days:</td>
                            <td width="200" align="left">
                                <span class="livemode">{if $invoice.recurring.paybefore}{$invoice.recurring.paybefore}{else}Default - {$automation.paybefore}{/if} day(s)</span>
                            </td>
                        </tr>
                        <tr>
                ...
                <table border="0" cellspacing="3" cellpadding="0">
                    ...
                    <tr>
                        {if !$is_recurring && $invoice.status!='Creditnote'} 
                            ...
                            <td width="200" align="left">
                                <span class="livemode">{$invoice.duedate|dateformat:$date_format}</span>
                            </td>
                        {/if}
                    ...
                    <tr>
                        {if !$is_recurring && $invoice.status!='Creditnote'}  
                            ...
                            <td width="200" align="left">
                                <span class="livemode">{$invoice.paybefore|dateformat:$date_format}</span>
                            </td>
                        {/if}
                    ...
                    <tr>
                        {if !$is_recurring}  
                            ...
                            <td width="200" align="left">
                                <strong class="invoice-total">{$invoice.total|price:$currency}</strong>
                            </td>
                        {/if}
                    ...
                    <div class="left">
                        ...
                        <table border="0" width="300" cellspacing="3" cellpadding="0" >
                            ...
                            <tr>
                                <td width="100" align="right" class="light">{$lang.frequency}:</td>
                                <td width="200" align="left">
                                    <select name="invoice[recurring][frequency]" >
                    ...
                    <table border="0" width="700" cellspacing="3" cellpadding="0" style="table-layout: fixed;">
                        <tr>
                            {if !$is_recurring}  
                                ...
                                <td width="200" align="left">
                                    {if $proforma && $invoice.paid_id!='' && $invoice.status!='Creditnote'}
                                        <input type="text" name="invoice[datepaid]" value="{$invoice.datepaid|dateformat:$date_format}" placeholder="{$invoice.datepaid|dateformat:$date_format}" class="haspicker"/>
                                    {else}
                                        <input type="text" name="invoice[date]" value="{$invoice.date|dateformat:$date_format}" placeholder="{$invoice.date|dateformat:$date_format}" class="haspicker"/>
                                    {/if}
                                </td>
                            {/if}
                        ...
                        <tr>
                            {if !$is_recurring  && $invoice.status!='Creditnote'}   
                                <td width="100" align="right"  class="light">{$lang.duedate}:</td>
                                <td width="200" align="left">
                                    <input type="text" name="invoice[duedate]" value="{$invoice.duedate|dateformat:$date_format}" class="haspicker"/>
                                </td>
                            {/if}

                            <td width="100" align="right" class="light">{$lang.taxlevel1}:</td>
                            <td width="200" align="left"><input type="text" name="invoice[taxrate]" size="7" value="{$invoice.taxrate}" /> %</td>

                            {if !$is_recurring}
                                <td width="100" align="right" class="light">{if "config:Invoice2ndcurrency:1"|checkcondition }1st currency rate{else}Currency rate{/if}:</td>
                                <td width="200">
                                    <input type="text" name="invoice[rate]" size="7" value="{$invoice.rate}" />
                                </td>
                            {/if}
                        ...
                        <tr>
                            {if !$is_recurring  && $invoice.status!='Creditnote'}   
                                <td width="100" align="right"  class="light">Pay Before:</td>
                                <td width="200" align="left">
                                    <input type="text" name="invoice[paybefore]" value="{$invoice.paybefore|dateformat:$date_format}" class="haspicker"/>
                                </td>
                            {/if}

                            <td width="100" align="right" class="light">{$lang.taxlevel2}:</td>
                            <td width="200" align="left" ><input type="text" name="invoice[taxrate2]" size="7" value="{$invoice.taxrate2}" /> %</td>

                            {if !$is_recurring && "config:Invoice2ndcurrency:1"|checkcondition }
                                <td width="100" align="right" class="light">2nd currency rate:</td>
                                <td width="200">
                                    <input type="text" name="invoice[rate2]" size="7" value="{$invoice.rate2}" />
                                </td>
                            {/if}
