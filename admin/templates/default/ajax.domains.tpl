...
{elseif $action=='getowners'}
    <center>
        ...
        <input type="submit" name="changeowner" value="{$lang.changedomainowner}" style="font-weight:bold" class="btn btn-primary btn-sm"/>
    ...
    <div class="fs11" style="text-align: right;padding-top: 5px">
        ...
        <div class="btn-group pull-left">
            ...
            <ul class="dropdown-menu">
                <li><a href="?cmd=tasklist&action=assigntask&id={$domain_id}&place=singledomain" onclick="return assignNewTask({$domain_id}, 'singledomain')">For this domain</a></li>
...
{elseif ($action=='regcommand' || $action=='callcustom') && $regcommand=="DNSmanagement"}
    ...
    {else}
        ...
        <div class="blu">
            <input type="submit" name="updateEmailForwarding" value="{$lang.savechanges}" onclick="return ext_submit(this);"/>
        </div>
    {/if}
