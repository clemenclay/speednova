...
<div class="blu">
    <div class="menubar">
        ...
        {if $action=='showprofile'}
            ...
            <a class=" menuitm menu-auto" href="{$system_url2}?action=adminlogin&id={$parent.client_id}&redirect=%3Fcmd%3Dprofiles%26action%3Dedit%26id%3D{$client.id}" target="_blank">
