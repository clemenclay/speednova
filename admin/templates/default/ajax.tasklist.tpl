...
{/literal}{/if}{if $cmd=='services' || $action=='getproducttasks' || $cmd=='accounts' || $cmd=='domains'}
{if $tasks}
        ...
        <tr  class="havecontrols"><td width="80">
                <div>
                    <a href="#"class="menuitm menu-auto" title="{$lang.Edit}" 
                       onclick="return TaskDetails({$task.id},{$product_id});" style="">
                        <span class="editsth"></span>
                    </a>
                    <a  href="#" class="menuitm menu-auto" title="{$lang.Remove}"  
                        onclick="return removeTask({$product_id},{$task.id});">
