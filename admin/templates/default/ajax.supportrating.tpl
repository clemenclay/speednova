    ...
    <div style="padding: 0px; display: block;" class="sectioncontent">
        {if $action !='config'}
            ...
            {else}
                ...
                <table class="table glike hover" cellpadding="6" cellspacing="0" style="width: 100%">
            ...
            <div class="nicerblu">
                <form method="POST" action="" onsubmit="return recalc();" id="ratingform">
                    <table width="100%" cellspacing="0" cellpadding="6" border="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="submit" name="submit" style="font-weight:bold" value="{$lang.savechanges}" class="btn btn-primary">
                            </td>
                        </tr>
                    </table>
                    {securitytoken}
