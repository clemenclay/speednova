            ...
            <td style="padding:6px" colspan="4">
                <select name="profile_id" class="form-control" >
                    {foreach from=$profiles item=cls }
                        <option value="{$cls.id}" {if $cls.id==$task.profile_id}selected="selected"{/if}>{$cls.name}</option>
                    {/foreach}
                </select>
            </td>
...
$('a.colorbox').colorbox({width:"80%", height:"80%", iframe:true,opacity:0.5});
                    ...
                    <table border="0" cellpadding="10" width="100%" cellspacing="0">
                        <tr class="bordme">
                            ...
                            <td>
                                <input name="MaintenanceMode" type="checkbox" value="on" {if $configuration.MaintenanceMode=='on'}checked="checked"{/if}  class="inp"/> 
                                {$lang.MaintenanceMode_descr}
                            </td>
                        </tr>
                        <tr class="bordme">
                            <td width="205" align="right"><strong>{$lang.BusinessName}</strong></td>
                            <td><input style="width:50%" name="BusinessName" value="{$configuration.BusinessName|escape}"  class="inp"/></td>
                        </tr>
                        <tr  class="bordme">
                            ...
                            <td>
                                ...
                                {foreach from=$templates item=t}
                                    <span {if $configuration.UserTemplate!=$t}style="display:none"{/if} class="cart_d"> 
                                        <a href="{$system_url}?systemtemplate={$t}" target="_blank" class="colorbox editbtn" title="{$t} template">{$lang.clicktopreview}</a>
                                    </span>
                                {/foreach}
                            </td>
                        </tr>
                            ...
                            <td>
                                <select style="width:40%" name="UserLanguage"  class="inp">
                                    {foreach from=$user_languages item=t}
                                        <option {if $configuration.UserLanguage==$t}selected="selected"{/if} value="{$t}">{$t|ucfirst}</option>
                                    {/foreach}
                                </select>
                                <span><a href="?cmd=langedit" class="colorbox editbtn" title="{$lang.languages}">{$lang.languages}</a></span>
                            </td>
                        </tr>
                        ...
                        <tr class="bordme">
                            <td align="right"><strong>Logging Level</strong></td><td><select style="width:50%" name="LoggerLevel" class="inp">
                                    <option value="100" {if $configuration.LoggerLevel=='100'}selected="selected"{/if}>DEBUG</option>
                                    <option value="200" {if $configuration.LoggerLevel=='200'}selected="selected"{/if}>INFO</option>
                                    <option value="250" {if $configuration.LoggerLevel=='250'}selected="selected"{/if}>NOTICE</option>
                                    <option value="300" {if $configuration.LoggerLevel=='300'}selected="selected"{/if}>WARNING</option>
                                    <option value="400" {if $configuration.LoggerLevel=='400'}selected="selected"{/if}>ERROR</option>
                ...
                <table border="0" cellpadding="10" width="100%" cellspacing="0">
                    ...
                    <tr >
                        <td width="205" align="right" valign="top"><strong>Multi-Item Cart</strong></td><td>
                            <input type="radio" name="ShopingCartMode" value="1" {if $configuration.ShopingCartMode=='1'} checked="checked"{/if}/> <strong>{$lang.Enable}</strong>, allow more than one service in cart<br />
                            <input type="radio" name="ShopingCartMode" value="0" {if $configuration.ShopingCartMode=='0'} checked="checked"{/if}/> <strong>{$lang.Disable}</strong>, only one service in cart<br />
                        </td>
                    </tr>
            ...
            <div class="sectioncontent" style="display:none">
                <table border="0" cellpadding="10" width="100%" cellspacing="0">
                    ...
                    <tr  class="bordme">
                        ...
                        <td>
                            <input style="width:30px" name="MaxAttachmentSize" value="{$configuration.MaxAttachmentSize}" class="inp"/>&nbsp;{$lang.MaxAttachmentSize_descr}
                        </td>
                    </tr>
                    <tr class="bordme">
                    ...
                    <tr class="bordme">
                        ...
                        <td>
                            <input name="TicketHTMLTags" type="radio" value="on" {if $configuration.TicketHTMLTags=='on'}checked="checked"{/if}  /> <strong>{$lang.yes}</strong>, html tags will be displayed in ticket message <br />
                            <input name="TicketHTMLTags" type="radio" value="off" {if $configuration.TicketHTMLTags=='off' || !$configuration.TicketHTMLTags }checked="checked"{/if}  /> <strong>{$lang.no}</strong>, html tags will be removed completely from tickets
                        </td>
                    </tr>
                    <tr  class="bordme">
                        ...
                        <td>
                            <input style="width:30px" name="TicketImportTimeLimit" value="{$configuration.TicketImportTimeLimit}" class="inp"/> seconds
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="sectioncontent" style="display:none">
                <table border="0" cellpadding="10" width="100%" cellspacing="0"  class="sectioncontenttable">
                    ...
                    <tr class="bordme euinvoices" {if $configuration.InvoiceModel!='eu'}style="display:none"{/if}>
                        ...
                        <td colspan="3">
                            <input name="InvoicePaidAutoReset" type="radio" value="0" {if $configuration.InvoicePaidAutoReset=='0'}checked="checked"{/if}  class="inp"/> 
                            <strong>{$lang.no}, </strong> {$lang.InvoicePaidAutoReset_descr}<br />
                            <input name="InvoicePaidAutoReset" type="radio" value="1" {if $configuration.InvoicePaidAutoReset=='1'}checked="checked"{/if}  class="inp"/>  
                            <strong>{$lang.yes}, </strong>{$lang.InvoicePaidAutoReset1_descr}<br />
                            <input name="InvoicePaidAutoReset" type="radio" value="2" {if $configuration.InvoicePaidAutoReset=='2'}checked="checked"{/if}  class="inp"/>  
                    ...
                    <tr class="bordme">
                        ...
                        <td colspan="3">
                            <input name="ContinueInvoices" type="radio" value="on" {if $configuration.ContinueInvoices=='on'}checked="checked"{/if}  class="inp"/> 
                            <strong>{$lang.yes}, </strong> {$lang.ContinueInvoices_descr}<br />
                            <input name="ContinueInvoices" type="radio" value="off" {if $configuration.ContinueInvoices=='off'}checked="checked"{/if}  class="inp"/>  
                    ...
                    <tr class="bordme">
                        ...
                        <td colspan="3">
                            <input name="GenerateSeparateInvoices" type="radio" value="off" {if $configuration.GenerateSeparateInvoices=='off'}checked="checked"{/if}  class="inp"/> 
                            <strong>{$lang.yes}, </strong> Automaticaly merge invoices generated on the same day (cron run)<br />
                            <input name="GenerateSeparateInvoices" type="radio" value="due" {if $configuration.GenerateSeparateInvoices=='due'}checked="checked"{/if}  class="inp"/> 
                            <strong>{$lang.yes}, </strong> Automaticaly merge genearated invoices with the same due date<br />
                            <input name="GenerateSeparateInvoices" type="radio" value="on" {if $configuration.GenerateSeparateInvoices=='on'}checked="checked"{/if}  class="inp"/>  
                            <strong>{$lang.no}, </strong> Generate separate invoice for each service
                        </td>
                    </tr>
                    ...
                    <tr class="bordme">
                        ...
                        <td colspan="3">
                            <input name="MergeDomainRenewals" type="checkbox" value="on" {if $configuration.MergeDomainRenewals=='on'}checked="checked"{/if}  class="inp"/>
                    ...
                    <tr >
                        ...
                        <td colspan="3">
                            ...
                            <input name="CancelInvoicesOnExpire" type="checkbox" value="on" {if $configuration.CancelInvoicesOnExpire=='on'}checked="checked"{/if}  /> Cancel renew invoices when related domain expires<br />
                            <input name="CancelInvoicesOnTerminate" type="checkbox" value="on" {if $configuration.CancelInvoicesOnTerminate=='on'}checked="checked"{/if}  /> Cancel overdue invoices when related account gets terminated<br />
                            <input name="CancelInvoicesOnDays" type="checkbox" value="on" {if $configuration.CancelInvoicesOnDays=='on'}checked="checked"{/if}  /> Cancel overdue invoices <input type="text" name="CancelInvoicesOnDaysValue" value="{$configuration.CancelInvoicesOnDaysValue}" size=3 /> days after due date<br />
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="10" width="100%" cellspacing="0" class="sectioncontenttable" style="display:none">
                    ...
                    <tr class="bordme" ><td align="right"><strong>{$lang.SupportedCC}</strong></td>
                        <td colspan="3"><input class="inp" value="{$configuration.SupportedCC}" name="SupportedCC" style="width:260px" /><br/><small>Provide comma separated list of accepted Credit Cards</small>
                        </td></tr>
                    ...
                    <tr class="bordme">
                        ...
                        <td colspan="3">
                            <input type="radio" name="CCUpdateLimit" value="off"
                                   {if $configuration.CCUpdateLimit!='on'}checked="checked"{/if} /><strong>{$lang.no}, </strong> 
                            There is no limit to credit card updates.
                            <br />

                            <input type="radio" name="CCUpdateLimit" value="on"
                                   {if $configuration.CCUpdateLimit=='on'}checked="checked"{/if} /> <strong>{$lang.yes}, </strong> 
                            Limit the amount of credit card updates to a client's account to
                            <input type="text" size="3" value="{$configuration.CCUpdateLimitTimes|default:3}" name="CCUpdateLimitTimes"/> 
                            time(s) per
                            <select name="CCUpdateLimitPariod">
                                <option {if $configuration.CCUpdateLimitPariod=='1'}selected="selected"{/if} value="1">Day</option>
                                <option {if $configuration.CCUpdateLimitPariod=='7'}selected="selected"{/if} value="7">Week</option>
                                <option {if $configuration.CCUpdateLimitPariod=='30'}selected="selected"{/if} value="30">Month</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr class="bordme">
                        ...
                        <td colspan="3">
                            <input type="radio" name="CCBanDeclined" value="off"
                                   {if $configuration.CCBanDeclined!='on'}checked="checked"{/if} /><strong>{$lang.no}, </strong> 
                            Process every credit card.
                            <br />

                            <input type="radio" name="CCBanDeclined" value="on"
                                   {if $configuration.CCBanDeclined=='on'}checked="checked"{/if} /> <strong>{$lang.yes}, </strong> 
                            Reject credit cards that were declined 
                            <input type="text" size="3" value="{$configuration.CCBanDeclinedTimes|default:3}" name="CCBanDeclinedTimes"/> 
                            time(s) or more. 
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <div class="chargefew" {if $configuration.CCChargeAuto!='on'}style="display:none"{/if}> <br />
                                <input type="radio" name="CCForceAttempt" value="off" {if !$configuration.CCForceAttempt || $configuration.CCForceAttempt=='off'}checked="checked"{/if}/> <strong>{$lang.no}</strong>, use payment module related to invoice to capture payment <br />
                                <input type="radio" name="CCForceAttempt" value="on" {if $configuration.CCForceAttempt=='on'}checked="checked"{/if}/> <strong>{$lang.Yes}</strong>, use credit card module if card is present and non-credit card gateway is related to invoice 
                            </div>
                        </td>
                ...
                <table border="0" cellpadding="10" width="100%" cellspacing="0" class="sectioncontenttable" style="display:none">
                    ...
                    <tr class="bordme">
                        ...
                        <td colspan="3">
                            <input type="radio" name="ACHAllowStorage" value="on" {if $configuration.ACHAllowStorage=='on'}checked="checked"{/if} />
                            <strong>Yes</strong>, allow saving bank details for later use<br />

                            <input type="radio" name="ACHAllowStorage" value="off" {if $configuration.ACHAllowStorage=='off'}checked="checked"{/if} />
                            <strong>No</strong>, do not store bank account details in database<br />
                        </td>
                    </tr>

                    <tr class="bordme"><td  align="right" valign="top"><strong>{$lang.ACHAllowRemove}</strong></td>
                        <td colspan="3">
                            <input type="radio"
                                   name="ACHAllowRemove"
                                   value="off"
                                   {if $configuration.ACHAllowRemove=='off'}checked="checked"{/if} /><strong>{$lang.no}, </strong> {$lang.ACHAllowRemove_dscr1}<br />

                            <input type="radio" name="ACHAllowRemove"
                                   value="on"
                                   {if $configuration.ACHAllowRemove=='on'}checked="checked"{/if} /> <strong>{$lang.yes}, </strong> {$lang.ACHAllowRemove_dscr2}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="text" size="3" {if $configuration.ACHChargeAuto!='on'}value="0"{else}value="{$configuration.ACHChargeAutoDays}"{/if} name="ACHChargeAutoDays"/> {$lang.CCChargeAuto2}
                            <br />

                            <div class="chargefew2" {if $configuration.ACHChargeAuto!='on'}style="display:none"{/if}> <br />
                                <input type="radio" name="ACHReChargeAuto" value="on" {if $configuration.ACHReChargeAuto=='on'}checked="checked"{/if}/> {$lang.CCAttemptOnce}<br />
                                <input type="radio" name="ACHReChargeAuto" value="off" {if $configuration.ACHReChargeAuto=='off'}checked="checked"{/if}/> {$lang.ACHAttemptOnce2}
                                <input type="text" size="3" name="ACHRetryForDays" value="{$configuration.ACHRetryForDays}" /> {$lang.days}
                            </div>
                        </td>
                ...
                <table border="0" cellpadding="10" width="100%" cellspacing="0" class="sectioncontenttable" style="display:none">
                    <tr class="bordme">
                        ...
                        <td >
                            <input type="radio" name="CnoteEnable" value="off" {if $configuration.CnoteEnable !='on'}checked="checked"{/if} onchange="c_note()" /> Disabled <br />
                            <input type="radio" name="CnoteEnable" value="on" {if $configuration.CnoteEnable =='on'}checked="checked"{/if} onchange="c_note()"/> Enabled
                        </td>
                    </tr>
...
<span id="testmailsuite2">
    Enter email address: <input type="text" name="testmail" id="testmailaddress" /> <a class="new_control" href="#"   onclick="testConfiguration() ;return false;"><span ><b>{$lang.Send}</b></span></a>
                        ...
                        <tr class="smtp" {if $configuration.MailUseSMTP=='off'}style="display:none"{/if}>
                            ...
                            <td><input class="inp" name="MailSMTPEmail" value="{$configuration.MailSMTPEmail}" style="width: 250px"/> </td>				
                        </tr>
                        
                        <tr class="smtp" {if $configuration.MailUseSMTP=='off'}style="display:none"{/if}>
                            <td width="205" align="right">{$lang.MailSMTPHost}</td>
                            <td><input class="inp" name="MailSMTPHost" value="{$configuration.MailSMTPHost}" style="width: 250px" /> 
                                {$lang.MailSMTPPort} <input class="inp" name="MailSMTPPort" value="{$configuration.MailSMTPPort}" size="3" /></td>				
                        </tr>

                        <tr class="smtp" {if $configuration.MailUseSMTP=='off'}style="display:none"{/if}>
                            <td width="205" align="right">{$lang.MailSMTPUsername}</td>
                            <td><input class="inp" name="MailSMTPUsername" value="{$configuration.MailSMTPUsername}" style="width: 250px" /> </td>				
                        </tr>

                        <tr class="smtp" {if $configuration.MailUseSMTP=='off'}style="display:none"{/if}>
                            <td width="205" align="right">{$lang.MailSMTPPassword}</td>
                            <td><input class="inp" name="MailSMTPPassword" value="{$configuration.MailSMTPPassword}" style="width: 250px"type="password" autocomplete="off" /> </td>				
                        </tr>
                    ...
                    <tr class="bordme"><td width="205" align="right"><strong>Limit mails per cron run </strong>
                        ...
                        </td><td><input  style="width:30px" name="EmailsPerCronRun" value="{$configuration.EmailsPerCronRun}" class="inp"/></td></tr>
                    ...
                    <tbody>
                        <tr class="bordme">
                            ...
                            <td><span>{$configuration.DecimalPlaces} - <a class="editbtn" href="#" onclick="return confirm('Note: Decreasing Decimal Places value will result in truncating all prices to fit new format.') && $(this).parent().hide() && $('#DecimalPlaces').show();">edit</a></span>
                                ...
                                {*}
                                <input style="display: none;" size="3" type="number" name="DecimalPlaces" max="20" id="DecimalPlaces" class="inp" value="{$configuration.DecimalPlaces}"
                         ...
                         <tr class="bordme">
                            ...
                            <td><span>{$configuration.DisplayDecimalPlaces} - <a class="editbtn" href="#" onclick="return $(this).parent().hide() && $('#DisplayDecimalPlaces').show();">edit</a></span>
                                ...
                                <input style="display: none;" size="3" type="number"  name="DisplayDecimalPlaces" max="20" id="DisplayDecimalPlaces" class="inp" value="{$configuration.DisplayDecimalPlaces}"
                                       onkeyup="if(parseInt($(this).val().replace(/\D/g,'')) > 20) $(this).val(20);"/>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="sectioncontent" style="display:none">
                ...
                <table border="0" cellpadding="10" width="100%" cellspacing="0" class="sectiontable7">
                    <tr class="bordme">
                        ...
                        <td>
                            <input name="ClientLogoutAfter" type="text" value="{$configuration.ClientLogoutAfter}" size="3"/> minutes
                        </td>
                    </tr>
                    <tr class="bordme">
                        <td align="right" width="205">
                    ...
                    <tr class="bordme">
                        ...
                        <td>
                            <input name="CanCancelUnpaidService" type="radio" value="on" {if $configuration.CanCancelUnpaidService=='on'}checked="checked"{/if}  /> <strong>{$lang.yes} </strong><br />
                            <input name="CanCancelUnpaidService" type="radio" value="off" {if $configuration.CanCancelUnpaidService!='on'}checked="checked"{/if}  /> <strong>{$lang.no} </strong>
                        </td>
                    </tr>
                    ...
                    <tr class="bordme">
                        ...
                        <td>
                            <input name="CanCancelUnpaidInvoice" type="radio" value="on" {if $configuration.CanCancelUnpaidInvoice=='on'}checked="checked"{/if}  /> <strong>{$lang.yes} </strong><br />
                            <input name="CanCancelUnpaidInvoice" type="radio" value="off" {if $configuration.CanCancelUnpaidInvoice!='on'}checked="checked"{/if}  /> <strong>{$lang.no} </strong>
                        </td>
                    </tr>
                    <tr class="bordme">
                        <td align="right" width="205">
                        ...
                        <td>
                            <input name="CanUpgradeUnpaidService" type="radio" value="on" {if $configuration.CanUpgradeUnpaidService=='on'}checked="checked"{/if}  /> <strong>{$lang.yes} </strong><br />
                            <input name="CanUpgradeUnpaidService" type="radio" value="off" {if $configuration.CanUpgradeUnpaidService!='on'}checked="checked"{/if}  /> <strong>{$lang.no} </strong>
                        </td>
                    </tr>
                    <tr class="bordme">
                        <td align="right" width="205">
                        ...
                        <td>
                            <input name="GrantDomainAccessToContacts" type="radio" value="1" {if $configuration.GrantDomainAccessToContacts}checked="checked"{/if}  /> 
                            <strong>{$lang.yes}</strong>,
                            add domain management privileges to contacts used for registration or transfer.
                            <br />
                            <input name="GrantDomainAccessToContacts" type="radio" value="0" {if !$configuration.GrantDomainAccessToContacts}checked="checked"{/if}  /> 
                ...
                <table border="0" cellpadding="10" width="100%" cellspacing="0" class="sectiontable7" style="display:none">
                    ...
                    <tr class="bordme">
                        ...
                        <td>
                            <input name="IncomeForecastSuspended" type="radio" value="on" 
                                   {if $configuration.IncomeForecastSuspended!='off'}checked="checked"{/if}  /> <strong>{$lang.yes} </strong><br />
                            <input name="IncomeForecastSuspended" type="radio" value="off" 
                                   {if $configuration.IncomeForecastSuspended=='off'}checked="checked"{/if}  /> <strong>{$lang.no} </strong>
                        </td>
                    </tr>
                     ...
                     <tr class="bordme">
                        ...
                        <td>
                            <input name="EnableClientCaptchaLogin" type="radio" value="on" {if $configuration.EnableClientCaptchaLogin=='on'}checked="checked"{/if}  /> <strong>{$lang.yes} </strong><br />
                            <input name="EnableClientCaptchaLogin" type="radio" value="off" {if $configuration.EnableClientCaptchaLogin=='off'}checked="checked"{/if}  /> <strong>{$lang.no} </strong>
                        </td>
                    </tr>
                    ...
                    <tr class="bordme">
                        ...
                        <td>
                            <input name="ForceHTTPS" type="radio" value="on" {if $configuration.ForceHTTPS=='on'}checked="checked"{/if}  /> <strong>{$lang.yes} </strong><br />
                            <input name="ForceHTTPS" type="radio" value="off" {if $configuration.ForceHTTPS!='on'}checked="checked"{/if}  /> <strong>{$lang.no} </strong>
                        </td>
                    </tr>
                    ...
                    <tr class="bordme">
                        ...
                        <td>
                            <textarea name="TrustedProxies" class="inp" placeholder="example: 192.168.1.0/24" style="width:500px;">{$configuration.TrustedProxies}</textarea>
                        </td>
                    </tr>
                     <tr class="bordme">
                         <td align="right" width="205" valign="top">
...
<script type="text/javascript">
    ...
    function bindMe() {
        ...
        $('#newshelfnav').TabbedMenu({elem:'.sectiontable7',picker:'.list-7elem',picktab:true,{/literal}{if $picked_subtab}picked:{$picked_subtab}{/if}{literal}});
