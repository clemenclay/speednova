                    ...
                    <table width="100%" cellspacing="2" cellpadding="3" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td width="35%">
                                    <select name="client_id"  style="width: 180px" load="clients" default="{$transaction.client_id}">
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" size="4" name="invoice_id" value="{$transaction.invoice_id}"/>                                     
                                    {if $transaction.invoice_id}
                                        <a href="?cmd=invoices&action=edit&id={$transaction.invoice_id}&list=all" 
                                           class="editbtn" target="_blank">{$lang.findrelatedinv}</a>
                                    {/if}
                                </td>
                                <td>{$lang.amountin}</td>
                                <td>
                                    <span class="currency_sign">{$transaction.currency.sign}</span> 
                                    <input type="text" value="{$transaction.in}" size="10" name="in"/> 
                                    <span class="currency_code">{$transaction.currency.code}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span class="currency_sign">{$transaction.currency.sign}</span> 
                                    <input type="text" value="{$transaction.fee}" size="10" name="fee"/> 
                                    <span class="currency_code">{$transaction.currency.code}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span class="currency_sign">{$transaction.currency.sign}</span> 
                                    <input type="text" value="{$transaction.out}" size="10" name="out"/> 
                                    <span class="currency_code">{$transaction.currency.code}</span>
                                </td>
                            </tr>
                        </tbody>
