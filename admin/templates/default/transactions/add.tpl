                    ...
                    <table width="100%" cellspacing="2" cellpadding="3" border="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" size="20" name="invoice_id" value="{$submit.invoice_id}"/>
                                </td>
                                <td>{$lang.amountin}</td>
                                <td>
                                    <span class="currency_sign">{$client_currency.sign}</span> 
                                    <input type="text" value="{$submit.in}" size="10" name="in"/> 
                                    <span class="currency_code">{$client_currency.code}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span class="currency_sign">{$client_currency.sign}</span> 
                                    <input type="text" value="{$submit.fee}" size="10" name="fee"/> 
                                    <span class="currency_code">{$client_currency.code}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="module" onclick="new_gateway(this)">
                                ...
                                <td>
                                    <span class="currency_sign">{$client_currency.sign}</span> 
                                    <input type="text" value="{$submit.out}" size="10" name="out"/> 
                                    <span class="currency_code">{$client_currency.code}</span>
                                </td>
                            </tr>
                        </tbody>
