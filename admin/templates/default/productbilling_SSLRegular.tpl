	...
	<table border="0" cellpadding="6" cellspacing="0" width="100%" id="Regular_b">
		...
		<tr id="p4pricing" class="havecontrols" {if $product.p4=='0.00' && $product.p4_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					{$lang.Price}: <input type="text" value="{$product.p4|price:$currency:false}" size="6" name="p4" class="inp"/> &nbsp;&nbsp;
					{$lang.setupfee}:  <input type="text" value="{$product.p4_setup|price:$currency:false}" size="6" name="p4_setup" class="inp"/>
                </div>
		...
		<tr id="p5pricing" class="havecontrols" {if $product.p5=='0.00' && $product.p5_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					{$lang.Price}: <input type="text" value="{$product.p5|price:$currency:false}" size="6" name="p5" class="inp"/> &nbsp;&nbsp;
					{$lang.setupfee}:  <input type="text" value="{$product.p5_setup|price:$currency:false}" size="6" name="p5_setup" class="inp"/>
                </div>
