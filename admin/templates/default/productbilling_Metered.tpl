                                    ...
                                    <table border="0" cellpadding="3" class="left" cellspacing="0" id="{$k}_table" >
                                        ...
                                        {if !$varx.prices}
                                          <tr >
                                            ...
                                            <td><input type="text" class="inp" size="6" value="{0.000|price:$currency:false:false}"  name="metered[{$k}][prices][0][price]" /> /{$varx.unit_name}</td>
                                        ...
                                        <tr >
                                            ...
                                            <td><input type="text" class="inp" size="6" value="{$p.price|price:$currency:false}"  name="metered[{$k}][prices][{$kx}][price]" /> /{$varx.unit_name}</td>
                                            <td><a class="fs11" href="#" onclick="return removeRow(this)">Remove</a></td>
                                        </tr>
                                        {/foreach}
                                    </table>
