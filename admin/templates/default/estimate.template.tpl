                    ...
                    <div class="list-2">
                        <div class="subm1 haveitems">
                            <ul >
                                ...
                                <li class="list-2elem picked" ><a href="?cmd=configuration&action=estimatetemplates"><span>Estimate customization</span></a></li>
                                <li class="list-2elem"><a href="?cmd=configuration&picked_tab=3&picked_subtab=1"><span>{$lang.creditcards}</span></a></li>
                                <li class="list-2elem"><a href="?cmd=configuration&picked_tab=3&picked_subtab=2"><span>{$lang.ACHecheck}</span></a></li>
                                <li class="list-2elem"><a href="?cmd=configuration&picked_tab=3&picked_subtab=3"><span>{$lang.clbalance}</span></a></li>
                                <li class="list-2elem"><a href="?cmd=configuration&picked_tab=3&picked_subtab=4"><span>Credit notes</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
