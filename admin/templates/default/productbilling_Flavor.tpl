            ...
            <tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td width="160">{$currency.sign} <input type="text" class="inp" size="6"  value="{if $configuration.FlavorSetupFee}{$configuration.FlavorSetupFee|price:$currency:false}{else}{0|price:$currency:false:false}{/if}" name="config[FlavorSetupFee]" /> {$currency.code}</td>
                ...
                <tr>
                    ...
                    <td>{$currency.sign} <input type="text" class="inp" size="6" value="{if $configuration.FlavorRecurringFee}{$configuration.FlavorRecurringFee|price:$currency:false}{else}{0|price:$currency:false:false}{/if}" name="config[FlavorRecurringFee]" /> {$currency.code}</td>
