     ...
     <table border="0" cellpadding="6" cellspacing="0" width="100%">
        <tr  id="hpricing" class="havecontrols" {if $product.h=='0.00' && $product.h_setup=='0.00'}style="display:none"{/if}>
            ...
            <td> <div class="e1">
                ...
                <div class="e2">
					    {$lang.Price}: <input type="text" value="{$product.h|price:$currency:false}" size="6" name="h" class="inp"/> &nbsp;&nbsp;
					    {$lang.setupfee}:<input type="text" value="{$product.h_setup|price:$currency:false}" size="6" name="h_setup" class="inp"/>
                </div></td>
        </tr>
        <tr  id="dpricing" class="havecontrols" {if $product.d=='0.00' && $product.d_setup=='0.00'}style="display:none"{/if}>
            ...
            <td> <div class="e1">
                ...
                <div class="e2">
					    {$lang.Price}: <input type="text" value="{$product.d|price:$currency:false}" size="6" name="d" class="inp"/> &nbsp;&nbsp;
					    {$lang.setupfee}:<input type="text" value="{$product.d_setup|price:$currency:false}" size="6" name="d_setup" class="inp"/>
                </div></td>
        </tr>
        ...
        <tr  id="wpricing"  class="havecontrols" {if $product.w=='0.00' && $product.w_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					   {$lang.Price}: <input type="text" value="{$product.w|price:$currency:false}" size="6" name="w" class="inp"/> &nbsp;&nbsp;
					   {$lang.setupfee}: <input type="text" value="{$product.w_setup|price:$currency:false}" size="6" name="w_setup" class="inp"/>
                </div></td>
        </tr>
        ...
        <tr id="mpricing" class="havecontrols" {if $product.m=='0.00' && $product.m_setup=='0.00' && !($product.d=='0.00' && $product.d_setup=='0.00' && $product.w=='0.00' && $product.w_setup=='0.00' && $product.q=='0.00' && $product.q_setup=='0.00' && $product.s=='0.00' && $product.s_setup=='0.00' && $product.a=='0.00' && $product.a_setup=='0.00' && $product.b=='0.00' && $product.b_setup=='0.00' &&  $product.t=='0.00' && $product.t_setup=='0.00' &&  $product.h=='0.00' && $product.h_setup=='0.00'&& $product.p4=='0.00' && $product.p4_setup=='0.00' &&  $product.p5=='0.00' && $product.p5_setup=='0.00')}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					   {$lang.Price}: <input type="text" value="{$product.m|price:$currency:false}" size="6" name="m" class="inp"/> &nbsp;&nbsp;
					    {$lang.setupfee}: <input type="text" value="{$product.m_setup|price:$currency:false}" size="6" name="m_setup" class="inp"/>
                </div>
            </td>
        </tr>
        ...
        <tr id="qpricing" class="havecontrols" {if $product.q=='0.00' && $product.q_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
                    <strong>{$lang.Price}: </strong><input type="text" value="{$product.q|price:$currency:false}" size="6" name="q" class="inp"/> &nbsp;&nbsp;
					   {$lang.setupfee}: <input type="text" value="{$product.q_setup|price:$currency:false}" size="6" name="q_setup" class="inp"/>
                </div></td>
        </tr>
        ...
        <tr id="spricing" class="havecontrols" {if $product.s=='0.00' && $product.s_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					    {$lang.Price}: <input type="text" value="{$product.s|price:$currency:false}" size="6" name="s" class="inp"/> &nbsp;&nbsp;
					    {$lang.setupfee}:  <input type="text" value="{$product.s_setup|price:$currency:false}" size="6" name="s_setup" class="inp"/>
                </div>
            </td>
        </tr>
        ...
        <tr id="apricing" class="havecontrols" {if $product.a=='0.00' && $product.a_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					    {$lang.Price}: <input type="text" value="{$product.a|price:$currency:false}" size="6" name="a" class="inp"/> &nbsp;&nbsp;
					   {$lang.setupfee}:  <input type="text" value="{$product.a_setup|price:$currency:false}" size="6" name="a_setup" class="inp"/>
                </div>
            </td>
        </tr>
        ...
        <tr id="bpricing" class="havecontrols" {if $product.b=='0.00' && $product.b_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
                    <strong>{$lang.Price}: </strong><input type="text" value="{$product.b|price:$currency:false}" size="6" name="b" class="inp"/> &nbsp;&nbsp;
                    <strong>{$lang.setupfee}: </strong> <input type="text" value="{$product.b_setup|price:$currency:false}" size="6" name="b_setup" class="inp"/>
                </div>
            </td>
        </tr>
        ...
        <tr id="tpricing" class="havecontrols" {if $product.t=='0.00' && $product.t_setup=='0.00'}style="display:none"{/if}>
            ...
            <td>
                ...
                <div class="e2">
					    {$lang.Price}: <input type="text" value="{$product.t|price:$currency:false}" size="6" name="t" class="inp"/> &nbsp;&nbsp;
					    {$lang.setupfee}:  <input type="text" value="{$product.t_setup|price:$currency:false}" size="6" name="t_setup" class="inp"/>
                </div>
    ...
    <div >
        <table border="0" cellpadding="3" cellspacing="0" width="100%">
			...
			{*<option  value="p4"  {if $product.p4!='0.00' || $product.p4_setup!='0.00'}style="display:none"{/if}>{$lang.Quadrennially}</option>
                ...
                <td><input type="text" value="{0|price:$currency:false:false}" size="6" name="newprice" id="newprice" class="inp"/>&nbsp;&nbsp;<strong>{$lang.setupfee}:</strong> <a href="#" class="editbtn" id="newsetup1">{$lang.Enable}</a><input type="text" value="{0|price:$currency:false:false}" size="6" name="newsetup" id="newsetup" class="inp" style="display:none"/></td>

                <td colspan="2" align="center"><input type="button" value="{$lang.Add}"  onclick="addopt();return false;" class="btn btn-primary btn-xs"/> <span class="orspace">{$lang.Or} </span> <a href="#" onclick="$('#addpricing').show();$('#tbpricing').hide();return false;" class="editbtn" id="hidepricingadd">{$lang.Cancel}</a></td>
            </tr>
        </table>
    </div>
</div>