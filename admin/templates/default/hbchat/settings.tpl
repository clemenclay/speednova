...
<div  class="nicerblu"><form action="" method="post" id="submitform">
        ...
        <table width="100%" cellspacing="0" cellpadding="6">
            ...
            <tr >
                <td width="180" align="right" ><strong>Auto-switch operators <a title="If operator is not able to pick up chat request HostBill will switch to another operator from this department.
                                                                                                <br> Enter number of seconds to auto-switch. Disable this option if you plan to use mobile notifications about pending chats" class="vtip_description"></a></strong></td>
                <td class="editor-container">
                    <input type="checkbox" class="styled inp" name="config[ChatRoundRobinEnable]" value="on" {if $configuration.ChatRoundRobinEnable=='on'}checked="checked"{/if} onclick="$('.roundrobinrow').toggle()"/>
                </td>
            </tr>
