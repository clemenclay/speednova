    ...
    <ul style="border:solid 1px #ddd;border-bottom:none;" id="grab-sorter"> {foreach from=$images item=i}
        <li style="background:#ffffff"><div style="border-bottom:solid 1px #ddd;">
                <table cellspacing="0" cellpadding="5" border="0" width="100%">
                    <tbody><tr>
                            <td width="80" valign="top"><div style="padding:10px 0px;"><input type="hidden" class="ser" value="464" name="sortc[]"><a name="f464"></a>
                                    <!--
                                    --><a style=""  title="Edit" class="menuitm menuf" href="?cmd=hbchat&action=widgets&do=editimage&id={$i.id}"><span class="editsth"></span></a><!--
