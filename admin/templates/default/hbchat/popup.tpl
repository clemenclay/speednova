...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="hbpopup">
                            ...
                            <div class="conversation_container">
                                ...
                                <div class="c_content">
                                    ...
                                    <div class="c_inputbar">
                                        ...
                                        <span class="sendbtn btn btn-primary"><span >Send</span></span>
                                        <div class="clear"></div>
                                    </div>
        ...
        <input type="button" value="Invite to chat" class="submitme btn btn-primary btn-sm" onclick="HBOperator.inviteVisitor('{{id}}')" style="font-weight:bold;font-size:11px !important"/>
                                        </div>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="display" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            <th width="40"></th>
                            <th width="90">IP</th>
                            <th width="90">Time online</th>
                            <th width="75">Footprints</th>
                            <th width="50">Chats</th>
                            <th>Current page</th>
                            <th>Referer</th>
                            <th width="55"></th>
                        </tr>
