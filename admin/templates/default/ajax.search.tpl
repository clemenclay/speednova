{if $results}
    ...
    {if $results.Invoices}
        <li class="choices-header choices-Invoices">{$lang.Invoices}</li>
            ...
            <li class="result"><a href="?cmd=invoices&action=edit&id={$re.id}&list=all">{$re|@invoice}
                    <span class="second">{$re.firstname} {$re.lastname}</span>
                </a>
            </li>
        {/foreach}
    ...
    {if $results.Orders}
        ...
        {/foreach}
    {/if}
    {if $results.RecurringInvoices}
        <li class="choices-header choices-Invoices">{$lang.Recurringinvoices}</li>
        {foreach from=$results.RecurringInvoices item=re}
            <li class="result"><a href="?cmd=invoices&action=edit&id={$re.id}&list=recurring">{$re|@invoice}
                    <span class="second">{$re.firstname} {$re.lastname}</span>
                </a>
            </li>
        {/foreach}
    ...
    {if $results.Estimates}
        <li class="choices-header choices-Invoices">{$lang.Estimates}</li>
        {foreach from=$results.Estimates item=re}
            <li class="result"><a href="?cmd=estimates&action=edit&id={$re.id}">#{$re.id}
                    <span class="second">{$re.firstname} {$re.lastname} - {$re.subject}</span>
                </a>
            </li>
        {/foreach}
    {/if}
