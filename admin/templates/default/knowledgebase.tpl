                    ...
                    <form method="post" action="">
                        <div class="lighterblue" style="padding: 10px;">
                            ...
                            <table width="800">
                                ...
                                <tr>
                                    <td>{$lang.adminonly}</td>
                                    <td>
                                        <input type="checkbox" value="1" name="admin_only" {if $reply.admin_only=='1'}checked="checked"{/if} />
                                        <a class="vtip_description" title="All articles/categories under this category will not be seen by customers"></a>
                                    </td>
                                </tr>
