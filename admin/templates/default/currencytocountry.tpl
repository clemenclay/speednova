                    ...
                    <div class="list-2">
                        <div class="subm1 haveitems">
                            <ul >
                                ...
                                <li class="picked"><a href="?cmd=currencytocountry"><span>Currency to country</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table cellspacing="0" cellpadding="3" border="0" width="100%" class="table glike hover">
                                        ...
                                        <tr id="adtax_bt">
                                            <th colspan="6" align="left">
                                                <a href="#" class="editbtn" onclick="$('#adtax_bt').hide();$('#addnewtax').show();return false;">Add new rule</a>&nbsp;
                                                <a href="?cmd=currencytocountry&make=addeur&security_token={$security_token}" class="editbtn" >Set EUR as default for EU countries</a>&nbsp;
                                                <a href="?cmd=currencytocountry&make=rmallrules&security_token={$security_token}" class="editbtn" onclick="return confirm('Are you sure?');" >Remove all rules</a>&nbsp;
                                            </th>
                                        </tr>
                                        </tbody>
