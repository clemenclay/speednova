                ...
                <tbody>
                    <tr>
                        ...
                        {else}
                            ...
                            <th  width="110" class="lastelb col_lastreply"><a href="?cmd=tickets&list={$currentlist}{if $currentdept}&dept={$currentdept}{/if}{$assigned}&orderby=priority DESC,t.lastreply|ASC"  class="sortorder">{$lang.Lastreply}</a></th>
                            {/if}
                    </tr>
                </tbody>
                <tbody id="updater">
