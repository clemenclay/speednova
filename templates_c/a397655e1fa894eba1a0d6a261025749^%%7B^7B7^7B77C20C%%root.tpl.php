                ...
                <div class="p-10 p-t-30">
                  <c3chart bindto-id="chart-line-1">
                    <chart-column column-id="Sales"
                                  column-values="<?php echo '{{chartData1}}'; ?>
"
                                  column-type="line"
                ...
                <div class="p-10 p-t-30">
                  <c3chart bindto-id="chart-line-2">
                    <chart-column column-id="Customers"
                                  column-values="<?php echo '{{chartData2}}'; ?>
"
                                  column-type="line"
                ...
                <div class="p-10 p-t-30">
                  <c3chart bindto-id="chart-line-3">
                    <chart-column column-id="Signups"
                                  column-values="<?php echo '{{chartData3}}'; ?>
"
                                  column-type="line"
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="progress m-b-5">
                      <div class="progress-bar" style="width: <?php echo '{{serverLoad}}'; ?>
%;"></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <div class="list-group" ng-init="(comments=[]).length=2;">
                <a href class="list-group-item clearfix" ng-repeat="i in comments track by $index">
                  <div class="pull-left m-r-10">
                    <i class="icon-circle <?php echo '{{theme_colors[$index]}}'; ?>
-border v-super"></i>
                  </div>
            ...
            <div class="card">
              ...
              <div class="m-t-20">
                <c3chart bindto-id="chart-area-1" padding-bottom="-8px"  padding-left="-20px" padding-right="-20px">
                  <chart-column
                    column-id="Customers"
                    column-values="<?php echo '{{chartData4}}'; ?>
"
                    column-type="area"
                    />
                  <chart-axis-y show="false"  />
        ...
        <div class="grey-text small p-t-20" ng-cloak>Materialism by Theme-Guys - v<?php echo '{{APP.version}}'; ?>
</div>
      </div>
    </div>
      ...
      <div class="p-h-40">
        ...
        <div role="tabpanel">
          ...
          <div class="tab-content m-t-10">
            <div role="tabpanel" class="tab-pane" ng-class="<?php echo '{active: actionTab==1}'; ?>
">
            ...
            <div role="tabpanel" class="tab-pane" ng-class="<?php echo '{active: actionTab==2}'; ?>
">
            ...
            <div role="tabpanel" class="tab-pane" ng-class="<?php echo '{active: actionTab==3}'; ?>
">
        ...
        <div class="row">
          <div class="col-xs-4">
            <c3chart bindto-id="chart-gauge-1">
              ...
              <chart-colors color-pattern="<?php echo '{{color_pattern}}'; ?>
"/>
            </c3chart>
