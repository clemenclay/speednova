                ...
                <div class="onapptab form" id="resources_tab">
                    ...
                    <table border="0" cellspacing="0" cellpadding="6" width="100%" >
                       ...
                       <!-- <tr>
                        ...
                        <td >
                            <div id="option21container" class="tofetch"><select name="options[option21][]" id="option21" multiple="multiple" class="multi">
                        ...
                        <div class="ftr">
                            <span class="fs11"> 
                                <input type="checkbox" class="formchecker"  rel="edgegroup" />Set separate group metered traffic pricing
                            </span>
                        </div>
                            </td>
                        </tr>
