...
<table class="table table-striped">
    ...
    {foreach from=$domains item=domain}
        <tr>
            <td>{$domain.domain}</td>
            <td>{if $domain.parent_id}Alias {if $domain.aliasOf} of {$domain.aliasOf.domain}{/if}{/if}</td>
            <td>
    ...
    <div class="modal-body">
        <form class="form-inline" method="post" action="">
            ...
            <div class="input-append">
                ...
                <input type="text" id="domain" name="addalias" class="span3"><button type="submit" class="btn btn-success">Create Alias</button>
                {securitytoken}
            </div>
