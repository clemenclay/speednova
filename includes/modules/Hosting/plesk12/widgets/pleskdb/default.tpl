<div >
    ...
    <div id="billing_info" class="wbox form-inline">
        <div class="wbox_header"> 
            <a href="{$widget_url}" {if $act == 'default'}class="active"{/if}>{$widget_lang.db_list}</a> 
            | <a href="{$widget_url}&act=usermanage" {if $act == 'usermanage'}class="active"{/if}>{$widget_lang.db_users}</a> 
        </div>
            ...
            <form autocomplete="off" action="{$widget_url}&act={$act}" method="post">
                <table class="checker table table-striped" width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    {elseif $act=='usermanage'}
                        ...
                        <thead>
                            <tr>
                                <td align="left">{$widget_lang.db_username}</td>
                                <td align="left">{$widget_lang.db_name}</td>
                                <td align="center" style="width: 50%">{$widget_lang.management_functions}</td>
                            </tr>
                        </thead>
                        <tbody id="updater">
                            {include file="$widget_dir`$widget.ajaxtpl`"}
                        ...
                        <tfoot>
                            ...
                            <tr><td colspan="3"  align="left">{$widget_lang.add_new_usr}</td></tr>
                            <tr>
