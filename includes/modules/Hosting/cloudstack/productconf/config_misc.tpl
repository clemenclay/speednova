<table border="0" cellspacing="0" width="100%" cellpadding="6">
    ...
    <tr>
        ...
        <td>
            <input type="radio" value="1" name="options[autopass]" {if $default.autopass=='1'}checked="checked"{/if}> 
            <strong>{$lang.yes}</strong>, try to obtain root password for VM as soon as it is created. <br />
            <input type="radio" value="0" name="options[autopass]" {if !$default.autopass || $default.autopass=='0'}checked="checked"{/if}> 
            <strong>{$lang.no}</strong>, clients should request root password manualy. <br />
        </td>
    </tr>
    <tr>
        <td width="160">
        ...
        <td>
            <div id="dynamicscaling" class="formcheckerbox">
                ...
                <strong>{$lang.yes}</strong>, allows updating CPU/RAM for a running VM avoiding any downtime. <br />
                ...
                <strong>{$lang.no}</strong>, updating CPU/RAM will restart the VM with increased resources. <br />
            </div>
    ...
    <tr style="display: none">
        <td width="160">
            <label>Disable volume shrink <br /><small>(Intended to use with qcow2)</small></label>
        </td>
        <td>
            <input type="checkbox" value="1" name="options[noshrink]" {if $default.noshrink=='1'}checked="checked"{/if}/> Disabled
        </td>
    </tr>
    {*}
    ...
    <tr class="odesc_ odesc_cloud_vm">
        ...
        <td>
            ...
            <strong>Custom</strong>, clients can set root disk size with slider when creating new VM. <br />
            ...
            <strong>Default</strong>, root disk size is defined by selected OS template. <br />
        </td>
    </tr>
    ...
    <tr class="odesc_ odesc_single_vm">
        ...
        <td> 
            ...
            <strong>{$lang.yes}</strong>, customers won't be able to use templates with more disk space than their current one. <br />
            ...
            <strong>{$lang.no}</strong>, customers can resinstall using any template. <br />
