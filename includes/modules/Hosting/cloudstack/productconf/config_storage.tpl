<table border="0" cellspacing="0" cellpadding="6" width="100%" >
    ...
    <tr class="odesc_ odesc_single_vm">
        <td width="180">
            <label >Root Disk size [GB] <a class="vtip_description" title="If left empty, root disk will use default value from template, or data disk size value in case of iso images"></a></label>
        </td>
        <td id="rootdisksizecontainer">
            <input type="text" size="3" name="options[rootdisksize]" value="{$default.rootdisksize|default:-1}" id="option6"/>
            <span class="fs11"  ><input type="checkbox" class="formchecker" rel="rootdisksize" />Allow client to adjust with slider during order</span> <br>
            
        </td>
    </tr>
    <tr id="primary_storage">
        <td width="180">
            <label class="odesc_ odesc_single_vm">Data Disk size [GB]</label>
            <label class="odesc_ odesc_cloud_vm">Primary Storage Limit [GB] <a class="vtip_description" title="Size limit for root and data disks."></a></label>
        </td>
    ...
    <tr id="secondary_storage">
        <td width="180"><label >Secondary Storage Limit [GB] <a class="vtip_description" title="Size limit for templates, iso images and disk volume snapshots."></a></label></td>
        <td id="secondarystoragelimitcontainer">
            <input type="text" size="3" name="options[secondarystoragelimit]" value="{$default.secondarystoragelimit}" id="option6"/>
            <span class="fs11"  ><input type="checkbox" class="formchecker" rel="secondarystoragelimit" />Allow client to adjust with slider during order</span> <br>
        </td>
    </tr>
    <tr>
        <td width="180"><label >Max Volume snapshots</label></td>
        <td><input type="text" size="3" name="options[option15]" value="{$default.option15}" id="option15"/></td>
    </tr>
    <tr>
        <td width="180"><label >Max VM snapshots</label></td>
        <td><input type="text" size="3" name="options[vmsnaplimit]" value="{$default.vmsnaplimit}" id="optvmsnaplimit"/></td>
    </tr>

    <tr>
        <td width="180"><label >Max templates</label></td>
        <td><input type="text" size="3" name="options[option16]" value="{$default.option16}" id="option16"/></td>
    </tr>

    <tr>
        <td width="180"><label > HA-enabled <a class="vtip_description" title="HA features work with iSCSI or NFS primary storage.  HA with local storage is not supported."></label></td>
    ...
    <tr>
        <td width="180"><label >Storage type<a class="vtip_description" title="Select where you want to deploy your VMs"></label></td>
        <td>
            <div id="primarystoragtypecontainer"  class="clearfix left">
                <span>Root storage (ROOT)</span><br/>
                <select name="options[primarystoragtype]" id="primarystoragtype" style="width: 150px">
            ...
            <div id="datastoragtypecontainer"  class="clearfix left" style="margin: 0 0 0 25px">
                <span>Data storage (DATA)</span><br/>
                <select name="options[datastoragtype]" id="datastoragtype" style="width: 150px">
                    <option value="shared" {if !$default.datastoragtype && $default.primarystoragtype == 'shared'}selected="selected"{/if} >Shared</option>
                    <option class="local" value="local" {if $default.datastoragtype == 'local'}selected="selected"{/if}>Local</option>
                </select>
            </div>
            <div class="clear"></div>                    
        </td>
    ...
    <tbody class="tofetch">
        <tr>
            ...
            <td>
                <div id="primarystoragecontainer" class="clearfix left">
                    <span>Root storage (ROOT)</span><br/>
                    <select name="options[primarystorage][]" id="primarystorage" multiple="multiple" class="multi" style="width: 150px">
                ...
                <div id="datastoragecontainer" class="tofetch2 clearfix left" style="margin: 0 0 0 25px">
                    <span>Data storage (DATA)</span><br/>
                    <select name="options[datastorage][]" id="datastorage" multiple="multiple" class="multi" style="width: 150px">
        ...
        <tr class="tier2storage">
            ...
            <td>
                <div id="primarystoragecontainer" class="clearfix left">
                    <span>Root storage (ROOT)</span><br/>
                    <select name="options[primarystorage2][]" id="primarystorage" multiple="multiple" class="multi" style="width: 150px">
                ...
                <div id="datastoragecontainer" class="tofetch2 clearfix left" style="width: 150px;margin: 0 0 0 25px">
                    <span>Data storage (DATA)</span><br/>
                    <select name="options[datastorage2][]" id="datastorage" multiple="multiple" class="multi" style="width: 150px">
    ...
    <tr>
        <td width="180" style="vertical-align: top"><label >Advanced storage options</label ></td>
        <td>
