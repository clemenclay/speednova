<table border="0" cellspacing="0" cellpadding="6" width="100%" >
    ...
    <tr>
        <td width="160">
            <label >Network Offering <a class="vtip_description" title="Selected network offering will be used to provision client network(s)"></a></label>
        </td>
        <td >
            <div id="networkofferingcontainer" class="tofetch" >
                <select name="options[networkoffering]" id="networkoffering" >
                    <option>{$default.networkoffering}</option>
                </select>
            </div>
            <span class="fs11"><input type="checkbox" class="formchecker" rel="networkoffering"  />Allow client to select during order</span>
            <div class="clear"></div>
        </td>
    </tr>
    <tr>
        <td width="160">
            <label >
                Network Limit
                <a class="vtip_description" title="Limits how many networks clients can create in cloudstack. If Advanced networking options is set to create sseparate networks this will be unlimited"></a>
            </label>
        </td>
        <td id="networklimitcontainer">
            <input type="text" size="3" name="options[networklimit]" value="{$default.networklimit}" id="networklimit"/>
        </td>
    </tr>
    <tr>
        <td width="160">
            <label >
                VPC Limit
                <a class="vtip_description" title="Limits how many VPC clients can create in cloudstack."></a>
            </label>
        </td>
        <td id="networklimitcontainer">
            <input type="text" size="3" name="options[vpclimit]" value="{$default.vpclimit}" id="vpclimit"/>
        </td>
    </tr>
</table>
