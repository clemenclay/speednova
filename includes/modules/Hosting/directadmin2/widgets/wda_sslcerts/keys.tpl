                    ...
                    {foreach from=$list item=entry}
                        <tr class="">
                            ...
                            <td class="actions-column">
                                <a href="{$widget_url}&act=keys&key={$entry.host|escape:'url'}"><span class="icon icon-pencil"></span></a>
                                <a href="{$widget_url}&act=keys&del={$entry.host|escape:'url'}&security_token={$security_token}"
                                   onclick="return confirm('Do You really want to delete this entry?')"><span class="icon icon-trash"></span></a>
                            </td>
                        </tr>
                    {foreachelse}
                        <tr class="">
