{literal}
    <script type="text/javascript">
        ...
        function loadExtras() {
            $('#pdumgr .power_row').each(function () {
                var row = $(this),
                    extras = $('.port_extras', row),
                    data = {
                        item_id: row.attr('data-item-id'),
                        port_id: row.attr('data-port-id'),
                        id: row.attr('data-id')
...
//                if(data.item_id && data.port_id)
//                    ajax_update('?cmd=pdu_snmp&action=loadextras', data, extras);
            });
        }
