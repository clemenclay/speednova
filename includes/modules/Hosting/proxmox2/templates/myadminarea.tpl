{if $showvms}
    ...
    <script type="text/javascript">
        ...
        {literal}
            function loadClientVMs() {
                $.post('?cmd=proxmox2&action=showvms', {id: p_service_id, server_id: p_app_id}, function (data) {
                    data = parse_response(data);
                    $('#uptable').html(data);
                    window.setTimeout(loadClientVMs, 60000);
                })
            }
        ...
        <style type="text/css">
            ...
            .wanip{
                background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAYAAABytg0kAAAAGElEQVQYV2NcsWLF/4iICEZGBgYGBhAHAEDwBvpmLfgRAAAAAElFTkSuQmCC);
    ...
    {/literal}
{/if}
<ul class="accor" style="display:none">
