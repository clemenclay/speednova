<div class="header-bar">
 ...
 {if $service.options.option19=='Yes'}
    <ul class="sub-ul">
        <li><a href="{$service_url}&vpsdo=editvm&vpsid={$vpsid}" class="{if $vpsdo=='editvm'}active{/if}" ><span>{$lang.scale}</span></a></li>
        <li><a href="{$service_url}&vpsdo=autoscaling&vpsid={$vpsid}" class="{if $vpsdo=='autoscaling'}active{/if}" ><span>{$lang.autoscaling}</span></a></li>
    </ul>
 {/if}
    <div class="clear"></div>
</div>
