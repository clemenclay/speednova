<div class="header-bar">
    ...
    <ul class="sub-ul">
        <li><a href="{$service_url}&vpsdo=editvm&vpsid={$vpsid}" class="{if $vpsdo=='backups'}active{/if}" ><span>{$lang.scale}</span></a></li>
        <li><a href="{$service_url}&vpsdo=autoscaling&vpsid={$vpsid}" class="{if $vpsdo=='disks'}active{/if}" ><span>{$lang.autoscaling}</span></a></li>
    </ul>
    <div class="clear"></div>
</div>
