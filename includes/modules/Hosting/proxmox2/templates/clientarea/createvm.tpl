...
<div class="content-bar nopadding" style="position:relative">
    <div class="resources_box">
        ...
        <div style="text-align: right"><a href="{$service_url}&vpsdo=resources" class="fs11">Increase limits</a></div>
    </div>
    ...
    <form method="post" action="">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="checker">
            ...
            {if $virtualization=='openvz' || $virtualization=='lxc' }
                <tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <select style="min-width:250px;" required="required" name="CreateVM[template_id]" id="virtual_machine_template_id"  >
            ...
            <tr>
                <td colspan="2">
                    <div class='input-with-slider'>
                        ...
                        <input type="text" size="4" required="required" name="CreateVM[cpu]" 
                               class="styled" value="{if $submit.CreateVM.cpu}{$submit.CreateVM.cpu}{else}{$CreateVM.limits.cpu}{/if}" 
                               id="virtual_machine_cpu"/>
            ...
            <tr>
                <td colspan="2" id="disk-row">
                    <div class='input-with-slider'>
                        ...
                        GB
                        <div class='slider' {if $virtualization=='openvz' || $virtualization=='lxc'}max='{$CreateVM.limits.disk-1}'{else} max='{$CreateVM.limits.disk}'{/if} 
                             total='{$CreateVM.limits.disk}' min='0' step='1' 
                             minus='#virtual_machine_swap_disk_size'  
                             target='#virtual_machine_cpu_primary_disk_size'>
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <tr id="swap-row">
                    <td colspan="2">
                        <div class='input-with-slider'>
                            ...
                            <input type="text" size="4" required="required" 
                                   name="CreateVM[swap_disk_size]" class="styled" 
                                   value="0" id="virtual_machine_swap_disk_size"/>
                            GB
                            <div class='slider' max='{$CreateVM.limits.disk-1}' min='1' step='1' 
                                 total='{$CreateVM.limits.disk}' minus='#virtual_machine_cpu_primary_disk_size'  
                                 target='#virtual_machine_swap_disk_size'></div>
                        </div>
                        <div class="clear"></div>
            ...
            {if $CreateVM.network_types}
                <tr>
                    <td colspan="2"><span class="slabel">Network device</span>
                        <select name="CreateVM[network_type_id]" 
                                id="virtual_machine_network_type_id"  
