<table class="tonapp"  width="100%" cellspacing=0>
    ...
    <td>
        <a title="{$lang.delete}" href="{$service_url}&vpsdo=snapshotschedule&vpsid={$vpsid}&schedule_id={$schedule.id}&do=delete&security_token={$security_token}" 
    ...
    <form action="" method="post" id>
        ...
        <table class="table"  cellspacing="0" style="border-top:solid 1px #DDDDDD; width: 100%">
            <tr>
                ...
                <td>
                    <b class="span2">{$lang.snapshotkeep}</b><br />
