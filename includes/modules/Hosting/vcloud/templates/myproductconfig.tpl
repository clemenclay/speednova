  ...
  <tr>
    ...
    <div class="onapptab form" id="vdc_tab">
        <table border="0" cellspacing="0" cellpadding="6" width="100%" >
            ...
            <tr>
                <td width="160"><label >Storage Profile</label></td>
                <td id="profilecontainer" class="tofetch"><input type="text" size="3" name="options[profile]" value="{$default.profile}" id="profile"/>
                </td>
            </tr>
            <tr>
