            ...
            <div style="margin-top:-1px;border: solid 1px #DDDDDD;padding:10px;margin-bottom:10px;background:#fff" id="onapptabcontainer">
                <div class="onapptab form" id="finish_tab">
                    <table border="0" cellspacing="0" width="100%" cellpadding="6">
                        <tr><td colspan="2" class="onapp-preloader" style=""><img src="templates/default/img/ajax-loader3.gif"> Fetching data from Google, please wait...</td></tr>
                        <tr >
                            <td width="160">
                                <label >Product </label>
                            </td>
                            <td>
                                <select name="options[skuid]" id="usertpl">
                                    {foreach from=$SKU item=item}
                                        <option {if $default.skuid == $item}selected="selected"{/if} value="{$item}">{$item}</option>
                                    {/foreach}
                                </select>                              
                            </td>
                        </tr>
                            ...
                            <td>
                                <select name="options[plantype]" id="usertpl">
                                    {foreach from=$plantypes item=item key=key}
                                        <option {if $default.plantype == $key}selected="selected"{/if} value="{$key}">{$item}</option>
                                    {/foreach}
                                </select>                              
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td id="numberofseatscontainer"><input type="text" size="3" name="options[numberofseats]" value="{$default.numberofseats}" id="domainlim"/>
                                <span class="fs11"  ><input type="checkbox" class="formchecker" rel="numberofseats" />Allow client to adjust with slider during order</span>
                            </td>
                        </tr>
                    </table>
                </div>
