    ...
    <div style="padding:10px 1em">
        ...
        <div class="blank_state_smaller blank_forms" id="blank_pdu">
            <div class="blank_info">
                ...
                IPAM module can work with  PowerDNS or cPanelDNS module, allowing your colocation/dedicated customers to manage their PTR records directly from clientarea.
                <br/><br/>
                <b>To enable rDNS management in HostBill</b>
                <ol>
                    <li>Go to Settings->Modules and enable PowerDNS or cPanelDNS module</li>
