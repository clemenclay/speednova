<form action="" method="post" id="serverform">
    <div class="lighterblue" style="padding: 10px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <ul>
                    <li><b>Matching nameservers.</b><br/> NS set in this product's configuration will be compared to domain nameservers. If nameservers match, DNS zone can be autocreated by this plugin.</li>
                    <li><b>Creating DNS management package.</b> <br/> Once customer visits DNS management section in his domain, and its nameservers are set to your servers, he will be redirected to account with DNS management feature for this package</li>
                </ul>
                <b>DNS package</b><br />
                <div class="col-md-6">
                ...
                <div class="col-md-2">
                    <a href="?cmd=services&amp;action=product&amp;id={$submit.package}" target="_blank" id="link_to_product" class="btn btn-default left"><i class="fa fa-external-link"></i></a>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body"><ul class="treeview left" style="padding-left:3px; }">
                    <li style="padding-top:1px">
                        <label>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body"><ul class="treeview left" style="padding-left:3px; }">
                    <li style="padding-top:1px">
                        <label>
                            <input type="radio" name="onmismatch" {if $submit.onmismatch == '1'}checked="checked"{/if} value="1" />
                            Yes, remove  zone when domain name servers change
                        </label>
                    </li>
                    <li class="last" style="padding-top:1px">
                        <label>
                            <input type="radio" name="onmismatch" {if $submit.onmismatch == '0'}checked="checked"{/if} value="2" />
    ...
    <div class="blu">
        ...
        <a class="btn btn-default" href="https://hostbill.atlassian.net/wiki/display/DOCS/Domain+DNS+automated+zone+creation" target="_blank">Learn more</a>
    </div>
</form>
