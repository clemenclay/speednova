...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        {if !$notverified}<li><a href="?cmd=smsverification&action=setnotverified&client_id={$client.client_id}">Set to: not-verified</a></li>{/if}
        {if $notverified}<li><a href="?cmd=smsverification&action=setverified&client_id={$client.client_id}">Set to: verififed</a></li>{/if}
    </ul>
</div>