                            ...
                            <tbody> <tr class="havecontrols">
                                        <td width="120" >
                                            <div style="padding:10px 5px;">
                                                <a class="sorter-ha menuitm menuf" style="margin-left:4px;" onclick="return false" href="#"><span title="move" class="movesth">&nbsp;</span></a><!--
                                                --><a class="menuitm menuc" style="" href="?cmd=flavormanager&action=edit&id={$field.id}"  title="edit"  ><span class="editsth"></span></a><!--
