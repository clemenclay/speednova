...
<form action="?cmd=module&module={$moduleid}&do=invoices" method="post" id="csvexport">
                ...
                <script type="text/javascript">
                    $(function () {
                        $(document).on('change', 'select[name=type]', function (e) {
                            var val = $(this).val();
                            if (val == 'invoice') {
                                $('.field_invoice').show().find('input').prop('disabled', false);
                                $('.field_item').hide().find('input').prop('disabled', true);
                            } else {
                                $('.field_item').show().find('input').prop('disabled', false);
                                $('.field_invoice').hide().find('input').prop('disabled', true);
                            }
                        })
                ...
                <tr>
                    ...
                    <td align="left">
                        <select name="type" class="inp">
                            <option value="invoice" selected="selected">General invoice info, no items</option>
                            <option value="items">Invoice items with invoice info</option>
                        </select>
                    </td>
    ...
    <div class="blu">
        <input type="submit" value="Download CSV"  style="font-weight:bold;"/>
    </div>
    {securitytoken}
</form>