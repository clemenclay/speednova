...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <body style="" onload="$('#username').focus();">
            ...
            {else}
                <div style="width:630px;margin:0px auto;position:relative;height:320px;padding:0px;min-height:100%">
                    <div style="width:630px;position:absolute;top:50%;margin-top:-230px;"><img src="{$template_dir}img/hb_logo.gif" style="margin-bottom:10px;" />
                        <div style="border:3px solid #85a8c8; padding:2px;margin-bottom:4px;background:#ffffff;">
                            <div>
                                <iframe id="duo_iframe" width="620" height="330" frameborder="0" style="background: url('../includes/modules/Other/duosecurity/templates/blank.png') repeat-y 50% 0"></iframe>
                            </div>
                        </div>
                        <div style="text-align:center;"><small>Powered by <a href="http://hostbillapp.com" target="_blank" >HostBill</a></small></div>
                    </div>
