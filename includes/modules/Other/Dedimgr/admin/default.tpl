        ...
        <div class="list-1">
            <ul>
                ...
                <li class="{if $do=='inventory'}active{/if}">
                    <a href="?cmd=module&module={$moduleid}&do=inventory"><span>Inventory templates</span></a>
                </li>
                ...
                *}
                ...
                <li class="{if $do=='viewlogs'}active{/if} last">
                    <a href="?cmd=module&module={$moduleid}&do=viewlogs"><span>Logs</span></a>
                </li>
            </ul>
        ...
        <div class="list-2">
            {if !$do}<div class="subm1 haveitems" >
                    <ul>
                        ...
                        {*}<li>
                        <a  href="?cmd=module&module={$moduleid}&do=viewlogs"><span>View logs</span></a>
                        </li>{*}
                    </ul>
