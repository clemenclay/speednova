            ...
            <table width="100%" cellspacing="0" cellpadding="5" border="0">
                <tbody><tr>
                        <td width="120" valign="top"><div style="padding:10px 0px;">
                                <a title="Edit" class="menuitm menu-auto" href="#" onclick="return editVendor('{$colo.id}')"><span class="editsth"></span></a>
                                <a  onclick="return confirm('Are you sure you want to delete this Vendor??');" title="delete" 
                                    class="menuitm menu-auto" href="?cmd=module&module={$moduleid}&do=vendors&make=deletevendor&security_token={$security_token}&vendor_id={$colo.id}">
