                    ...
                    <table width="100%" cellspacing="0" cellpadding="5" border="0">
                        <tbody><tr>
                                <td width="120" valign="top"><div style="padding:10px 0px;">
                                        <a class="sorter-ha menuitm menu-auto" href="?cmd=module&module={$moduleid}&do=floor&floor_id={$floor.id}"><span >Racks</span></a>
                                        <a title="Edit" class="menuitm menu-auto" href="#" onclick="return editFloor('{$floor.id}')"><span class="editsth"></span></a>
                                        <a href="?cmd=module&module={$moduleid}&do=removefloor&floor_id={$floor.id}&colo_id={$floor.colo_id}" 
