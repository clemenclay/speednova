...
<ul class="im-dashboard clear">
    ...
    <li>
        <a href="#" class="fa-icon" data-grid="guarantee" >
            ...
            <span>Expiring Guarantees</span>
        </a>
    </li>
    <li>
        <a href="#" class="fa-icon" data-grid="support" >
            <i class="fa fa-stethoscope fa-5x"></i>
            <span> Expiring Support</span>
        </a>
    </li>
    <li>
        <a href="#" class="fa-icon" data-grid="builds" >
            <i class="fa fa-spinner fa-5x"></i>
            <span>Pending server builds</span>
        </a>
    </li>
</ul>
<div id="cnt_search" class="subcontent" style="display: none;">
    <p>Enter item serial number: <input type="text" name="sn" id="itemsearch" onkeyup="return searchItems(this, event);"></p>
</div>
{literal}
    <style>
        .im-dashboard{
