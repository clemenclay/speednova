                ...
                <tr>
                    ...
                    <td align="right">
                        <div style="padding:26px 0 0;">
                            <a href="#" class="new_control greenbtn" onclick="saveChangesField();
                                    return false"><span>{$lang.Add}</span></a></div>
                    </td>
                </tr>
            </tbody></table>
    </div>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="5" border="0">
                            <tbody><tr>
                                ...
                                <td valign="top" align="right">
                                    <div style="padding:5px 0px;"><a href="#" class="menuitm" title="delete"  style="width:12px;height:14px;display:block; box-sizing: content-box;" onclick="$('#condition_field_new_val').val(0);
                                            $('#conditional_{$k}').remove();
                                            saveChangesField();
                                            return false"><span class="delsth"></span></a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
