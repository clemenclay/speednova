...
class Smarty
{
     ...
     * EXCEPT PHP_TAGS - if you want to use them, enable PHP_TAGS here!
     *
     * @var array
     */
 ...
 */
    ...
    function templateExists($tpl_file) {
        return $this->template_exists($tpl_file);
    }
    ...
    function trigger_error($error_msg, $error_type = E_USER_WARNING)
    {
        ...
        throw new Exception("Smarty error: $error_msg", $error_type);
        else trigger_error("Smarty error: $error_msg", $error_type);
    }

    
    public static function throwExceptions($fa = true){
        self::$throwExceptions = $fa;
    }
   ...
   /**
    ...
    function _smarty_include($params)
    {
        ...
        $tmptdir = $this->template_dir;
        if(!empty($params['smarty_include_vars']['template_dir'])){
            $this->template_dir = MAINDIR.$params['smarty_include_vars']['template_dir'];
        }
