...
<div class="content-bar">
    ...
    {if $fieldupgrades}
        ...
        <form action="" method="post">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="ttable upgrade-table">
                <thead>
                    <tr>
                        <th  width="160"></th>
                        <th   width="160" align="center">{$lang.oldsetting}</th>
                        <th   align="center" >{$lang.newsetting}</th>
                    </tr>
                </thead>
                ...
                <tr>
                    <td colspan="3"> 
                        <input type="submit" value="{$lang.continue}" class="blue"/>
                    </td>
                </tr>
        ...
        {/if}
            ...
            {if true || $upgrades && $upgrades!=-1}
                <h3 class="summarize">{$lang.uppckg}</h3>
                <div id="addon_bar" class="addon-bar">
                    <form action="" method="post">
