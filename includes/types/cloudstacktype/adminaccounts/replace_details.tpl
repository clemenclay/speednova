...
<form action="" method="post" id="account_form" >
    ...
    <div id="ticketbody" >
        ...
        <ul class="tabs" id="tabbedmenu">
            ...
            <li class="tpicker"><a href="#tab2" onclick="loadClientMachines_cloudstack(); return false">Virtual Machines<span  class="top_menu_count" id="vm_count"></span> </a></li>
        ...
        <div class="tab_container">
            ...
            <div class="tab_content" style="display: none;">
                <div id="lmach">
                    <div style="text-align: center"><img src="{$template_dir}/img/ajax-loading.gif" alt="Loading.."/></div>
                </div>
...
<script type="text/javascript">
            ...
            function loadClientMachines_cloudstack() {
                clearTimeout(_cloudstack_t);
                
                if($('#vm_count').data('loaded') && !$('#tabbedmenu .tpicker').eq(2).hasClass('active')){
                    _cloudstack_t = setTimeout (loadClientMachines_cloudstack, 10000);
                    return;
                }
                ...
                $.get(url, function(data){
                    ...
                    _cloudstack_t = setTimeout (loadClientMachines_cloudstack, 60000);
                });
            }
           //appendLoader('loadClientMachines_cloudstack');
</script> 
{/literal}
{literal}
<style type="text/css">
