...
<div class="content-bar ">
     ...
     {if $service.flavor_enabled && $service.showbilling && ($service.status=='Active' || $service.status=='Suspended')}
          ...
          <div class="report">
            ...
            <link rel="stylesheet" href="includes/types/amazonec2type/clientarea/demo_table.css" type="text/css" />
            <script type="text/javascript" src="includes/types/amazonec2type/js/jquery.dataTables.min.js"></script>
        {literal}   
             <style>
                 .report .value {
                    font-size: 27px;
    ...
    <div class="mseparator"></div>
        ...
        <div id="pricingtable"> {include file="`$cloudstackdir2`flavor_table.tpl"}</div>
