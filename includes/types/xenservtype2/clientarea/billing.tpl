{include file="`$oldreselldir`header.cloud.tpl"}
<div class="header-bar">
    <h3 class="{$vpsdo} hasicon">Billingdawdawd</h3>
    <div class="clear"></div>
</div>
<div class="content-bar ">
    ...
    {if $service.metered && $service.showbilling && ($service.status=='Active' || $service.status=='Suspended')}
        ...
        <h3 class="summarize">{$lang.nextinvoicedetails}</h3>
    ...
    <link rel="stylesheet" href="includes/types/xenservtype2/clientarea/demo_table.css" type="text/css" />
    <script type="text/javascript" src="includes/types/xenservtype2/js/jquery.dataTables.min.js"></script>
    {literal}    <script type="text/javascript">
        ...
        <div id="pricingdetails">
            ...
            <div id="pricingtable"> {include file="`$reselldir`metered_table.tpl"}</div>
        ...
        {include file="`$oldreselldir`footer.cloud.tpl"}