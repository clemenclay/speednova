    ...
    {elseif $service.cert_id!=''  && ($service.cert_status=='Certificate Issued' || $service.cert_status=='Processing' || $service.cert_status=='Expired')}
        ...
        <form action="" method="post">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="checker table">
                        ...
                        {if $service.status!='Pending' && ($service.cert_status=='Certificate Issued' || $service.cert_status=='Expired')}
                            <tr class="lastone">
                                ...
                                <td><a href="#" onclick="$(this).hide();
                                        return getEnomInfo({$service.id}, 'getCertificate', '#certdetails')" {if $enomdo=='getCertificate' && $sslcert}style="display:none"{/if}>{$lang.clicktoview}</a>
            ...
            <div class="wbox" >
                ...
                <div class="wbox_content">
                    {if $service.cert_status=='Certificate Issued'}	{$lang.en_certiss_info}  {/if}<a href="#" onclick="$(this).hide();
                            return getEnomInfo({$service.id}, 'getWebDetails', '#webtdetails')">{$lang.clicktoview}</a>
            ...
            <div class="wbox" >
                ...
                <div class="wbox_content">
                    ...
                    {if $service.cert_status=='Certificate Issued'}	{$lang.en_certiss_info} {/if}<a href="#" onclick="$(this).hide();
                            return getEnomInfo({$service.id}, 'getContacts', '#cntdetails')">{$lang.clicktoview}</a>
