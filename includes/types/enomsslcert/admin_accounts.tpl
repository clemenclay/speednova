                ...
                <table cellspacing="2" cellpadding="3" border="0" width="100%" >
                    <tbody>
                        ...
                        <tr >
                            ...
                            <td >
                                <input name="cert_id" value="{$details.cert_id}" size="5"  
                                       class="{if $details.status!='Pending' && $details.status!='Terminated' && $details.cert_id!=''}manumode{/if}"
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <input type="hidden" name="cert_oid" value="{$details.cert_oid}"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <input name="cert_expires" value="{$details.cert_expires|dateformat:$date_format}" size="16"  
                        ...
                        <tr>
                            <td>CSR</td>
                            <td id="csrbox"><a href="#" onclick="ajax_update('?cmd=accounts&action=edit&id={$details.id}&edo=getCSR', false, '#csrbox', true);
                                    return false;">Show CSR</a></td>
                        </tr>
                        <tr>
                            <td>Certicate</td>
