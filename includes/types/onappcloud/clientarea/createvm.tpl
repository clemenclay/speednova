...
<div class="content-bar nopadding" style="position:relative">
    ...
    <form method="post" action="" class="create-vm-form">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="checker">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <select style="min-width:420px;" required="required" name="CreateVM[template_id]" id="virtual_machine_template_id" onchange="swapcheck($(this).val());
            ...
            <tr id="license_type">
                <td colspan="2">
                    <span class="slabel">{$lang.licensingtype}</span>
            ...
            <tr id="license_own">
                <td colspan="2">
                    <span class="slabel">{$lang.licensekey}</span>
