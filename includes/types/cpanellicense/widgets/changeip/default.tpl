    ...
    <div id="cartSummary" class="wbox_content">
        <center>
            <form method="post" action="">
                ...
                <input type="submit" style="font-weight:bold" value="{if $lang[$widget.name]}{$lang[$widget.name]}{elseif $widget.fullname}{$widget.fullname}{else}{$widget.name}{/if}" class="padded">
