<link rel="stylesheet" href="../includes/types/cloudstacktype/adminaccounts/demo_table.css" type="text/css" />
...
<form action="" method="post" id="account_form" >
    ...
    <div id="ticketbody" >
        ...
        <ul class="tabs" id="tabbedmenu">
            ...
            <li class="tpicker"><a href="#tab2" onclick="return false">Flavor Billing</a></li>
        ...
        <div class="tab_container">
            ...
            <div class="tab_content" style="display: none;">
                ...
                {if !$flavor_enable}
                  Flavor billing is disabled for this package, <a href="?cmd=services&action=product&id={$details.product_id}" target="_blank">click here to manage product pricing.</a>
                {else}
                <table class="whitetable" width="100%" cellspacing="0" cellpadding="3">
                    <tr class="odd">
                        
                        <td width="100" align="right"><b>Next invoice total</b></td>
                        <td ><b>{$details.flavor_total|price:$details.currency}</b></td>
                ...
                <div id="meteredusagelog" style="width:100%">
                   {include file="`$onappdir2`flavor_table.tpl"}
                </div>
...
<script type="text/javascript">
            ...
            function destroyVM_cloudstack(url) {
            ...
            function power_cloudstack(url,what) {
            ...
            function loadClientMachines_cloudstack() {
           ...
           {/literal}{if $details.status == 'Active'}appendLoader('loadClientMachines_cloudstack');{/if}{literal}
</script> {/literal}
{literal}
<style type="text/css">
    ...
    a.power.on-inactive, a.power.off-inactive, a.power.on-disabled, a.power.off-disabled {
        background: transparent url({/literal}{$system_url}{literal}includes/types/cloudstacktype/images/power-bg.png) no-repeat scroll 0 0;
    }

    a.power.on-inactive:hover {
        background: transparent url({/literal}{$system_url}{literal}includes/types/cloudstacktype/images/power-bg.png) no-repeat scroll -32px 0;
    }

    a.power.off-inactive:hover {
        background: transparent url({/literal}{$system_url}{literal}includes/types/cloudstacktype/images/power-bg.png) no-repeat scroll -64px 0;
    }

    a.power.on-active {
        background: transparent url({/literal}{$system_url}{literal}includes/types/cloudstacktype/images/power-bg.png) no-repeat scroll -96px 0;
    }

    a.power.off-active {
        background: transparent url({/literal}{$system_url}{literal}includes/types/cloudstacktype/images/power-bg.png) no-repeat scroll -128px 0;
    }
    .power.pending {
        background: transparent url({/literal}{$system_url}{literal}includes/types/cloudstacktype/images/power-bg.png) no-repeat scroll -160px 0;
        width: 65px;
    ...
    .power-status .yes {
        background:url("{/literal}{$system_url}{literal}includes/types/cloudstacktype/images/vm-on.png") no-repeat scroll 0 0 transparent;
        display:block;
        height:16px;
        text-indent:-99999px;
        width:16px;
    ...
    .power-status .no {
        background:url("{/literal}{$system_url}{literal}includes/types/cloudstacktype/images/vm-off.png") no-repeat scroll 0 0 transparent;
        display:block;
        height:16px;
        text-indent:-99999px;
        width:16px;
