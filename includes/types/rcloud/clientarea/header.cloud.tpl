<link media="all" type="text/css" rel="stylesheet" href="includes/types/rcloud/clientarea/styles3.css" />
<script type="text/javascript" src="includes/types/rcloud/clientarea/scripts.js"></script>
<script type="text/javascript" src="includes/types/rcloud/js/scripts.js"></script>

{if $widget.appendtpl }
    {include file=$widget.appendtpl}
{/if}
<div id="nav-onapp">
    <h1 class="left os-logo {if $VMDetails}{$VMDetails.distro}{elseif $vmdistro}{$vmdistro}{/if}">{if $VMDetails}{$VMDetails.name}{else}{$vmhostname}{/if}</h1>
     <ul class="level-1">
