		...
		<li><a href="#">Certificate Info</a>
			<div class="sor">
				<table cellspacing="2" cellpadding="3" border="0" width="100%" >
					<tbody>
						<tr >
							<td width="150">SSL Product ID</td>
							<td >
						...
						<tr>
							...
							<td >
								...
								{/if}
								{if $details.cert_status=='completed' || $details.cert_status=='active' || $details.cert_status=='valid'}
						...
						<tr>
							...
							<td >
								...
								{if $details.cert_status=='awaiting-approval'}
									<input type="submit" value="Resend" onclick="$('body').addLoader();  $(this).after('<input type=\'hidden\' name=\'edo\' value=\'sendmail\' />')"/>
								{/if}
