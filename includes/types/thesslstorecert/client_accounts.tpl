						...
						<tr>
							...
							<tr class="lastone ">
								<td colspan="4" style="text-align: right">
									...
									<input type="submit" value="{$lang.resendapproveemail}" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('sendmail')"/>
									{/if}
									{if $status.state=='active' || $status.state=='complete' || $status.state=='valid'}
									<input type="submit" value="{$lang.dwdcert}" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('resendcert')"/>
									{/if}
									{if $status.is_renewable=='1'}
									<input type="submit" value="{$lang.renew}" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('renew')"/>
									{/if}
									<input type="submit" value="{$lang.synchronize}" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('Synchronize')"/>
