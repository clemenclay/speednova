        ...
        <div class="tab_container">
            ...
            <div class="tab_content" style="display: none;">
                <table cellspacing="0" cellpadding="3" border="0" width="100%" class="whitetable">
                    ...
                    <tbody>
                        <tr>
                            <th colspan="{if $metered_enable}1{else}3{/if}" style="font-weight:normal">Domains count:  <b {if $dom_limit && $user_domains_cnt==$dom_limit}style="color:red"{/if}>{$user_domains_cnt}</b> Max allowed: <b>{$dom_limit}</b></th>
                           {if $metered_enable}
