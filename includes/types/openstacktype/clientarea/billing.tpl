...
<div class="content-bar ">
    ...
    <div class="mseparator"></div>
          ...
          {/if}
            ...
            <link rel="stylesheet" href="includes/types/openstacktype/clientarea/demo_table.css" type="text/css" />
            <script type="text/javascript" src="includes/types/openstacktype/js/jquery.dataTables.min.js"></script>
    ...
    <div class="mseparator"></div>
        ...
        <div id="pricingtable"> {include file="`$clouddir`metered_table.tpl"}</div>
