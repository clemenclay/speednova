{if $service}
    ...
    {if $service.showbilling}
        ...
        <tr >
            <td align="right">{$lang.period}</td>
            <td>{if $service.billingcycle == "Annually"}1 
            {elseif $service.billingcycle == "Biennially"}2
            {elseif $service.billingcycle == "Triennially"}3
            {elseif $service.billingcycle == "Quadrennially"}4
            {elseif $service.billingcycle == "Quinquennially"}5{/if} {$lang.years}
        </td>
    </tr>
{/if}
