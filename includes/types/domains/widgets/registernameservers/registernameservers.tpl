         ...
         <input type="hidden" name="widgetdo" value="RegisterNameServers" />
            ...
            {if $getRegisterNameServers}
                        ...
                        {foreach from=$ips item=ip name=ip_list}
                            <tr height="30">
                                ...
                                <td  style="{if !$smarty.foreach.ip_list.last}border-bottom: 0px;{/if} text-align: center">
									...
									<a href="" onclick="show_nsedit(this); return false;" class="ip_notedit">{$lang.edit}</a>
								</td>
                                <td {if !$smarty.foreach.ip_list.last}style="border-bottom: 0px"{/if}>
									<a href="" onclick="if(confirm('{$lang.deleteregnsconfirm}')) update_regns(this, 'deleteNameServer'); return false;" class="editbtn">{$lang.delete}</a>
								</td>
                            </tr>
                        {/foreach}
                    {/foreach}
                ...
                <tr>
                        ...
                        <td><input type="submit" name="widgetaction[registerNameServer]" value="{$lang.savechanges}" /></td>
                </tr>
