...
<link rel="stylesheet" href="../includes/types/onappsmarttype/adminaccounts/demo_table.css" type="text/css" />
<script type="text/javascript" src="../includes/types/onappsmarttype/js/jquery.dataTables.min.js"></script> 
...
<form action="" method="post" id="account_form" >
    ...
    <div id="ticketbody" >
        ...
        <ul class="tabs" id="tabbedmenu">
            ...
            {if $metered_enable}<li class="tpicker"><a href="#tab2" onclick="return false">Metered Billing</a></li>{/if}
...
<style type="text/css">
    ...
    a.power.on-inactive, a.power.off-inactive, a.power.on-disabled, a.power.off-disabled {
        background: transparent url({/literal}{$system_url}{literal}includes/types/onappsmarttype/images/power-bg.png) no-repeat scroll 0 0;
    }

    a.power.on-inactive:hover {
        background: transparent url({/literal}{$system_url}{literal}includes/types/onappsmarttype/images/power-bg.png) no-repeat scroll -32px 0;
    }

    a.power.off-inactive:hover {
        background: transparent url({/literal}{$system_url}{literal}includes/types/onappsmarttype/images/power-bg.png) no-repeat scroll -64px 0;
    }

    a.power.on-active {
        background: transparent url({/literal}{$system_url}{literal}includes/types/onappsmarttype/images/power-bg.png) no-repeat scroll -96px 0;
    }

    a.power.off-active {
        background: transparent url({/literal}{$system_url}{literal}includes/types/onappsmarttype/images/power-bg.png) no-repeat scroll -128px 0;
    }
    .power.pending {
        background: transparent url({/literal}{$system_url}{literal}includes/types/onappsmarttype/images/power-bg.png) no-repeat scroll -160px 0;
        width: 65px;
    ...
    .power-status .yes {
        background:url("{/literal}{$system_url}{literal}includes/types/onappsmarttype/images/vm-on.png") no-repeat scroll 0 0 transparent;
        display:block;
        height:16px;
        text-indent:-99999px;
        width:16px;
    ...
    .power-status .no {
        background:url("{/literal}{$system_url}{literal}includes/types/onappsmarttype/images/vm-off.png") no-repeat scroll 0 0 transparent;
        display:block;
        height:16px;
        text-indent:-99999px;
        width:16px;
