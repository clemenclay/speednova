<link media="all" type="text/css" rel="stylesheet" href="includes/types/onappsmarttype/clientarea/styles3.css" />
<script type="text/javascript" src="includes/types/onappsmarttype/clientarea/scripts.js"></script>
<script type="text/javascript" src="includes/types/onappsmarttype/js/scripts.js"></script>
...
<div id="nav-onapp">
    ...
    {/if}
     <ul class="level-1">
        ...
        {if $o_sections.o_network}<li class="{if $vmsection=='network'}current-menu-item{/if}"><a href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=ips&vpsid={$vpsid}"><span class="resources">{$lang.networkzone}</span></a></li>{/if}
