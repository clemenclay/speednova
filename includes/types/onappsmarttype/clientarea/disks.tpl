...
<table class="data-table backups-list"  width="100%" cellspacing=0>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=disks&vpsid={$vpsid}&do=autobackupoff&diskid={$disk->_id}&security_token={$security_token}" class="iphone_switch_container iphone_switch_container_on" onclick="return powerchange(this,'Disable autobackup?');"><img src="includes/types/onappsmarttype/images/iphone_switch_container_off.png" alt="" /></a>

            {else}
            <a href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=disks&vpsid={$vpsid}&do=autobackupon&diskid={$disk->_id}&security_token={$security_token}" class="iphone_switch_container iphone_switch_container_off" onclick="return powerchange(this,'Enable autobackup?');"><img src="includes/types/onappsmarttype/images/iphone_switch_container_off.png" alt="" /></a>
