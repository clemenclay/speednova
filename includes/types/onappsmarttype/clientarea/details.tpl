            ...
            <td colspan="2">
                <table border="0" cellspacing="0" cellpadding="5" style="margin-bottom:20px;" width="100%">
                    <tr><td width="120"><b>{$lang.tags}</b></td>
                        ...
                        <input type="button" onclick="$(this).toggle();$('#fida').toggle()" class="blue" style="margin-left:50px;padding:2px 3px;" value="Add new tag"></td>
                    </tr>
