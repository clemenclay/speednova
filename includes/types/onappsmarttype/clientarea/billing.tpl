...
<div class="content-bar ">
    ...
    <div class="mseparator"></div>
            ...
            {if $service.metered_type!='PrePay'}<h3 class="summarize">{$lang.nextinvoicedetails} <span>({$lang.updatedhourly})</span></h3>{/if}
          ...
          {/if}
            ...
            <link rel="stylesheet" href="includes/types/onappsmarttype/clientarea/demo_table.css" type="text/css" />
