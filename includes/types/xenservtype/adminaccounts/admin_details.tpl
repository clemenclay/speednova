                                    ...
                                    <td>
                                        {if $field.type == 'input'}
                                            ...
                                            {if $field_key == 'option6'}
                                                <button class="{if $details.status!='Pending' && $details.status!='Terminated'}manumode{/if}"  {if $details.manual!='1' && $details.status!='Pending' && $details.status!='Terminated'}style="display:none"{/if} onclick="show_vms();
                                                                    $(this).hide();
                                                                    return false">Select VM (Load from server)</button>
                                            {/if}
                ...
                {literal}
                    <script type="text/javascript">
                        ...
                        function show_vms() {
                            ...
                            var inp = $('input[name="extra_details[option6]"]');
                                inp.wrap('<div class="left" />');
                                inp.parent().addLoader();
                            $.post(url,{vpsdo: 'list_vms','current':inp.val()},function(data){
