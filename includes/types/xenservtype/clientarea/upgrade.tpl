<div class="header-bar">
    <h3 class="resources hasicon">Resize</h3>

    <div class="clear"></div>
</div>
<div class="content-bar">
    <div class="notice">After upgrade/downgrade your virtual machine will be automatically restarted<br/>
NOTE: Disk space cannot be downgraded
    </div>
    ...
    <form action="" method="post">
	  ...
	  {$lang.pickcycle}
        ...
        <script type="text/javascript">
            ...
            function sss(el) {
                $('.up_desc').hide();
                var index=$(el).get(0).selectedIndex;
